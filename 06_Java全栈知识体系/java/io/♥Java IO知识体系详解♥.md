...
- [Java NIO - 基础详解](Java NIO - 基础详解.md)
  - 新的输入/输出 (NIO) 库是在 JDK 1.4 中引入的，弥补了原来的 I/O 的不足，提供了高速的、面向块的 I/O
- [Java NIO - IO多路复用详解](Java NIO - IO多路复用详解.md)
  - 本文主要对IO多路复用，Ractor模型以及Java NIO对其的支持
- [Java AIO - 异步IO详解](Java AIO - 异步IO详解.md)
  - 本文主要对异步IO和Java中对AIO的支持详解。@pdai

> **D. Java进阶 - IO框架之开源框架**：最后再对常用的开源框架进行分析和详解。@pdai

- [Java NIO - 零拷贝实现](Java NIO - 零拷贝实现.md)这里转一篇Java NIO 零拷贝的实现文章，在此之前建议先理解什么是Linux中零拷贝，可以先看这篇文章。本文从源码着手分析了 Java NIO 对零拷贝的实现，主要包括基于内存映射（mmap）方式的 MappedByteBuffer 以及基于 sendfile 方式的 FileChannel。最后在篇末简单的阐述了一下 Netty 中的零拷贝机制，以及 RocketMQ 和 Kafka 两种消息队列在零拷贝实现方式上的区别。
- [Java N(A)IO - 框架: Netty](Java N(A)IO - 框架： Netty.md)
