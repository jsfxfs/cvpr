...
请参看： [关键字: volatile详解](../thread/java-thread-x-key-volatile.md)
...
AtomicReferenceFieldUpdater具体可以参考：[JUC原子类: CAS, Unsafe和原子类详解](../thread/java-thread-x-juc-AtomicInteger.md)
