...
> JDK 16 在 2021 年 3 月 16 号发布！根据发布的规划，这次发布的 JDK 17 是一个长期维护的版本（LTS)。Java 16 提供了数千个**性能**、**稳定性**和**安全性**更新，以及 **17 个 JEP**（JDK 增强提案），进一步改进了 Java 语言和平台，以帮助开发人员提高工作效率。@pdai
...
![](https://www.pdai.tech/images/java/java-avx-1.png)
