...
- `workQueue` 用来保存等待被执行的任务的阻塞队列. 在JDK中提供了如下阻塞队列: 具体可以参考[JUC 集合: BlockQueue详解](java-thread-x-juc-collection-BlockingQueue.md)
...
![](https://www.pdai.tech/images/thread/java-thread-x-executors-2.png)
