...
本文对J.U.C进行知识体系解读，后续的文章还针对几乎所有的核心的类以及常用的`工具类`作了详细的解读; 如果没有时间详细阅读相关章节，可以跟着本文站在一定的高度了解JUC下包的设计和实现；同时对重要的章节提供跳转链接，您可以链接过去详读。@pdai
...
- [Java 并发 - 理论基础](java-thread-x-theorty.md)
- [Java 并发 - 线程基础](java-thread-x-thread-basic.md)
- [关键字: synchronized详解](java-thread-x-key-synchronized.md)
- [关键字: volatile详解](java-thread-x-key-volatile.md)
- [关键字: final详解](java-thread-x-key-final.md)
...
在[JUC锁: AbstractQueuedSynchronizer详解](java-thread-x-lock-AbstractQueuedSynchronizer.md)中类的**内部类-conditionobject类**有具体分析。
...
详细分析请看: [JUC锁: AbstractQueuedSynchronizer详解](java-thread-x-lock-AbstractQueuedSynchronizer.md)
...
详细分析请看: [JUC锁: LockSupport详解](java-thread-x-lock-LockSupport.md)

### 锁常用类: ReentrantLock

> ReentrantLock为常用类，它是一个可重入的互斥锁 Lock，它具有与使用 synchronized 方法和语句所访问的隐式监视器锁相同的一些基本行为和语义，但功能更强大。

详细分析请看: [JUC锁: ReentrantLock详解](java-thread-x-lock-ReentrantLock.md)
...
详细分析请看: [JUC工具类: ReentrantReadWriteLock详解](java-thread-x-lock-ReentrantReadWriteLock.md)
...
详细分析请看: [Java 8 - StampedLock详解](../java8/java8-stampedlock.md)

### 工具常用类: CountDownLatch

> CountDownLatch为常用类，它是一个同步辅助类，在完成一组正在其他线程中执行的操作之前，它允许一个或多个线程一直等待。

详细分析请看: [JUC工具类: CountDownLatch详解](java-thread-x-juc-tool-countdownlatch.md)
...
详细分析请看: [JUC工具类: CyclicBarrier详解](java-thread-x-juc-tool-cyclicbarrier.md)

### 工具常用类: Phaser

> Phaser是JDK 7新增的一个同步辅助类，它可以实现CyclicBarrier和CountDownLatch类似的功能，而且它支持对任务的动态调整，并支持分层结构来达到更高的吞吐量。

详细分析请看: [JUC工具类: Phaser详解](java-thread-x-juc-tool-phaser.md)
...
详细分析请看: [JUC工具类: Semaphore详解](java-thread-x-juc-tool-semaphore.md)
...
详细分析请看: [JUC工具类: Exchanger详解](java-thread-x-juc-tool-exchanger.md)
...
详细分析请看: [JUC并发集合: BlockingQueue详解](java-thread-x-juc-collection-BlockingQueue.md)
...
详细分析请看: [JUC并发集合: ConcurrentLinkedQueue详解](java-thread-x-juc-collection-ConcurrentLinkedQueue.md)
...
详细分析请看: [JUC并发集合: CopyOnWriteArrayList详解](java-thread-x-juc-collection-CopyOnWriteArrayList.md)
...
详细分析请看: [JUC并发集合: ConcurrentHashMap详解](java-thread-x-juc-collection-ConcurrentHashMap.md), 包含了对JDK 7和JDK 8版本的源码分析。
...
对CAS，Unsafe类，以及13个原子类详解请参考：详细分析请看: [JUC原子类: CAS, Unsafe和原子类详解](java-thread-x-juc-AtomicInteger.md)
...
详细分析请看: [JUC线程池: FutureTask详解](java-thread-x-juc-executor-FutureTask.md)
...
详细分析请看: [JUC线程池: ThreadPoolExecutor详解](java-thread-x-juc-executor-ThreadPoolExecutor.md)
...
详细分析请看: [JUC线程池: ScheduledThreadExecutor详解](java-thread-x-juc-executor-ScheduledThreadPoolExecutor.md)
...
详细分析请看: [JUC线程池: Fork/Join框架详解](java-thread-x-juc-executor-ForkJoinPool.md)
