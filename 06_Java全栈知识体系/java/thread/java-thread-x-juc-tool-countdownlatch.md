...
![](https://www.pdai.tech/images/thread/java-thread-x-countdownlatch-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-countdownlatch-2.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-countdownlatch-3.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-countdownlatch-4.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-countdownlatch-5.png)

说明: 此时，Sync queue队列里的结点个数未发生变化，但是此时，AQS的state已经变为1了。

- t2线程执行countDownLatch.countDown操作，主要调用的函数如下。

![](https://www.pdai.tech/images/thread/java-thread-x-countdownlatch-6.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-countdownlatch-7.png)
