...
- 这里也可以一并看下: [算法思想 - 分治算法](../../algorithm/alg-core-divide-and-conquer.md)
...
![](https://www.pdai.tech/images/thread/java-thread-x-forkjoin-5.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-forkjoin-6.png)
...
- 首先推荐阅读ForkJoinPool的作者Doug Lea的一篇文章《A Java Fork/Join Framework》[英文原文地址](http://gee.cs.oswego.edu/dl/papers/fj.pdf)
