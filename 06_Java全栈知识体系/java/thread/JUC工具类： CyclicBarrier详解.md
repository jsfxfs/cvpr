...
![](https://www.pdai.tech/images/thread/java-thread-x-cyclicbarrier-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-cyclicbarrier-2.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-cyclicbarrier-3.png)

说明: 由上图可知，假设t1线程的cb.await是在main线程的cb.barrierAction动作是由最后一个进入屏障的线程执行的。根据时序图，进一步分析出其内部工作流程。

- main(主)线程执行cb.await操作，主要调用的函数如下。

![](https://www.pdai.tech/images/thread/java-thread-x-cyclicbarrier-4.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-cyclicbarrier-5.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-cyclicbarrier-6.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-cyclicbarrier-7.png)

说明: 其中，由于main线程是在AQS.CO的wait中被park的，所以恢复时，会继续在该方法中运行。运行过后，t1线程被unpark，它获得cpu资源可以继续运行。

- t1线程获取cpu资源，继续运行，下图给出了主要的方法调用。

![](https://www.pdai.tech/images/thread/java-thread-x-cyclicbarrier-8.png)
