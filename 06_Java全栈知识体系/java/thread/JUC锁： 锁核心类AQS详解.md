...
这和我们以往通过实现接口的方式有很大区别，模板方法模式请参看：[设计模式行为型 - 模板方法(Template Method)详解](../../dev-spec/pattern/行为型 - 模板方法(Template Method).md)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-2.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-3.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-4.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-5.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-6.png)

说明: 经过一系列的方法调用，最后达到的状态是禁用t2线程，因为调用了LockSupport.park。

- t1线程调用lock.unlock，其方法调用顺序如下，只给出了主要的方法调用。

![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-7.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-8.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-9.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-10.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-16.png)

说明: 其中，head设置为包含c1线程的结点，c1继续运行。

- c1线程执行fullCondtion.signal，其方法调用顺序如下，只给出了主要的方法调用。

![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-17.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-18.png)

说明: 最终c2线程会获取锁资源，继续运行用户逻辑。

- c2线程执行emptyCondition.await，由前面的第七步分析，可知最终的状态如下。

![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-19.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-20.png)

- p2继续运行，执行emptyCondition.signal，根据第九步分析可知，最终到达的状态如下。

![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-21.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-aqs-22.png)
