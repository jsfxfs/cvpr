...
![](https://www.pdai.tech/images/thread/java-thread-x-key-schronized-x1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-key-schronized-4.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-key-schronized-5.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-key-schronized-6.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-key-schronized-7.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-key-schronized-8.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-key-schronized-9.png)
...
> `ReentrantLock`为常用类，它是一个可重入的互斥锁 Lock，它具有与使用 synchronized 方法和语句所访问的隐式监视器锁相同的一些基本行为和语义，但功能更强大。详细分析请看: [JUC锁: ReentrantLock详解](java-thread-x-lock-ReentrantLock.md)
