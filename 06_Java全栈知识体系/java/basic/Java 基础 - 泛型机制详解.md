...
![](https://www.pdai.tech/images/java/java-basic-generic-1.png)
...
![](https://www.pdai.tech/images/java/java-basic-generic-2.png)

- 擦除方法定义中的类型参数

擦除方法定义中的类型参数原则和擦除类定义中的类型参数是一样的，这里仅以擦除方法定义中的有限制类型参数为例。

![](https://www.pdai.tech/images/java/java-basic-generic-3.png)
