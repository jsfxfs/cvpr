...
> MongoDB的WiredTiger存储引擎背后采用了什么样的数据结构呢？本文将从`常见引擎数据结构`，`典型B-Tree数据结构`，`磁盘数据结构`, `内存数据结构`, `Page数据结构`等方面详解介绍。@pdai
...
![](https://www.pdai.tech/images/db/mongo/mongo-y-ds-1.jpg)
...
![](https://www.pdai.tech/images/db/mongo/mongo-y-ds-2.jpg)
...
![](https://www.pdai.tech/images/db/mongo/mongo-y-ds-4.jpg)

假如现在插入一个16，最终结果如下：

![](https://www.pdai.tech/images/db/mongo/mongo-y-ds-5.jpg)
...
- [文章来源](https://mongoing.com/archives/35143)
- 作者：郭远威
