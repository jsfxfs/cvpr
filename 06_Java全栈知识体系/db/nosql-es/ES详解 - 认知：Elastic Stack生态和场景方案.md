...
> 在了解ElaticSearch之后，我们还要了解Elastic背后的生态即我们常说的ELK；与此同时，还会给你展示ElasticSearch的案例场景，让你在学习ES前对它有个全局的印象。@pdai
...
![](https://www.pdai.tech/images/db/es/es-introduce-2-1.png)

### beats+logstath+elasticsearch+kibana

![](https://www.pdai.tech/images/db/es/es-introduce-2-2.png)
...
![](https://www.pdai.tech/images/db/es/es-introduce-2-3.png)

### beats+MQ+logstash+elasticsearch+kibana

![](https://www.pdai.tech/images/db/es/es-introduce-2-4.png)
...
![](https://www.pdai.tech/images/db/es/es-introduce-2-8.png)

两个数据采集中心（比如采集两个工厂的数据），采集数据后的汇聚

![](https://www.pdai.tech/images/db/es/es-introduce-2-9.png)

数据分散，跨集群的搜索

![](https://www.pdai.tech/images/db/es/es-introduce-2-10.png)
