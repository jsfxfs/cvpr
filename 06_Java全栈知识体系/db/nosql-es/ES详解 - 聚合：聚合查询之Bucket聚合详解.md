...
> 除了查询之外，最常用的聚合了，ElasticSearch提供了三种聚合方式： **桶聚合（Bucket Aggregation)**，**指标聚合（Metric Aggregation)** 和 **管道聚合（Pipline Aggregation)**。本文主要讲讲**桶聚合（Bucket Aggregation)**。@pdai
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-2.png)
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-3.png)
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-4.png)
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-5.png)
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-6.png)
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-7.png)
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-8.png)
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-9.png)
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-10.png)
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-11.png)

结果很容易理解，不过应该注意到直方图的键值是区间的下限。键 0 代表区间 0-19，999 ，键 20000 代表区间 20，000-39，999 ，等等。

![](https://www.pdai.tech/images/db/es/es-agg-bucket-33.png)
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-12.png)

对应报表：

![](https://www.pdai.tech/images/db/es/es-agg-bucket-34.png)
