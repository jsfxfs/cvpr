...
> 前文主要讲了 ElasticSearch提供的三种聚合方式之**桶聚合（Bucket Aggregation)**，本文主要讲讲**指标聚合（Metric Aggregation)**。@pdai

## 如何理解metric聚合

> 在[bucket聚合](elasticsearch-x-agg-bucket.md)中，我画了一张图辅助你构筑体系，那么metric聚合又如何理解呢？

如果你直接去看官方文档，大概也有十几种：

![](https://www.pdai.tech/images/db/es/es-agg-metric-1.png)
