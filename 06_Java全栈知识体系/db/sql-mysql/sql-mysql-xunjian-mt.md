...
![](https://www.pdai.tech/images/db/mysql/db-mysql-xunjian-mt-1.png)
...
![](https://www.pdai.tech/images/db/mysql/db-mysql-xunjian-mt-2.png)
...
![](https://www.pdai.tech/images/db/mysql/db-mysql-xunjian-mt-3.png)
...
![](https://www.pdai.tech/images/db/mysql/db-mysql-xunjian-mt-4.png)
...
![](https://www.pdai.tech/images/db/mysql/db-mysql-xunjian-mt-5.png)

下面的隐患趋势图，展示了近一年中隐患的个数，数量突然增长是由于新的巡检项上线。从整体趋势上看，隐患存量有非常明显的下降。

![](https://www.pdai.tech/images/db/mysql/db-mysql-xunjian-mt-6.png)

除了推动内部隐患治理之外，我们还通过对接先知平台，积极推动RD治理隐患数量超过5000个。

![](https://www.pdai.tech/images/db/mysql/db-mysql-xunjian-mt-7.png)

为了提升用户体验，我们在提升准确率方面也做了重点的投入，让每一个巡检在上线前都会经过严格的测试和校验。

对比其他先知接入方，DBA上报隐患在总量、转化率、反馈率几个指标上都处于较高水平，可见我们上报的隐患风险也得到了RD的认可。

![](https://www.pdai.tech/images/db/mysql/db-mysql-xunjian-mt-8.png)
