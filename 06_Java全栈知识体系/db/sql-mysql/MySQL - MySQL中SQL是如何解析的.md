...
![](https://www.pdai.tech/images/db/mysql/db-mysql-sql-parser-1.png)
...
![](https://www.pdai.tech/images/db/mysql/db-mysql-sql-parser-2.png)
...
![](https://www.pdai.tech/images/db/mysql/db-mysql-sql-parser-3.png)

上面图示中，列名username、ismale存储在item_list中，表名存储在table_list中，条件存储在where中。其中以where条件中的Item层次结构最深，表达也较为复杂，如下图所示。

![](https://www.pdai.tech/images/db/mysql/db-mysql-sql-parser-4.png)
...
![](https://www.pdai.tech/images/db/mysql/db-mysql-sql-parser-5.png)

b）1=2 and (m > 3 and n > 4)

![](https://www.pdai.tech/images/db/mysql/db-mysql-sql-parser-6.png)

c）1=1 or (m > 3 and n > 4)

![](https://www.pdai.tech/images/db/mysql/db-mysql-sql-parser-7.png)

d）1=2 or (m > 3 and n > 4)

![](https://www.pdai.tech/images/db/mysql/db-mysql-sql-parser-8.png)
