...
- 排序章节，建议你看这里：[排序 - Overview](../../algorithm/♥常见排序算法知识体系详解♥.md)
- 归并排序(Merge Sort)建议你看这里：[排序 - 归并排序(Merge Sort)](../../algorithm/排序 - 归并排序(Merge Sort).md)

归并排序是把问题拆分为小问题，通过解决小问题来解决最初的问题（注：这种算法叫分治法，即『分而治之、各个击破』），具体建议你看：[算法思想 - 分治算法](../../algorithm/算法思想 - 分治算法.md) 和 [算法思想 - 二分法](../../algorithm/算法思想 - 二分法.md)。
...
> 数据库中查询的时间复杂度，是我们无法使用矩阵，转而使用二叉搜索树(BST)，具体请参考： [树 - 二叉搜索树(BST)](../../algorithm/树 - 二叉搜索树(BST).md)
...
- 这就是为什么引入B+树索引, 具体请参考这篇：[MySQL - 索引(B+树)](../sql-mysql/MySQL - 索引(B+树).md)
...
- 建议你回顾这篇文章：[线性表(散列) - 哈希表](../../algorithm/线性表(散列) - 哈希表.md)
