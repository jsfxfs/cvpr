...
> 很多人在学习数据库时都是孤立的学习知识点，这样是很难将所有知识点串起来深入理解；强烈推荐你学习两篇文章：[Architecture of a Database System](https://dsf.berkeley.edu/papers/fntdb07-architecture.pdf)以及[How does a relational database work](http://coding-geek.com/how-databases-work)；本文主要在第二篇基础上翻译并梳理，如果你英文不好的话，可以通过本文帮助你构筑数据库体系的基础。再啰嗦下，**这篇文章关注的不是知识点，而是知识点之间的关联**。@pdai

## 本文知识点

![](https://www.pdai.tech/images/arch_sqlyuanli.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-1.png)
...
- 排序章节，建议你看这里：[排序 - Overview](../../algorithm/alg-sort-overview.md)
- 归并排序(Merge Sort)建议你看这里：[排序 - 归并排序(Merge Sort)](../../algorithm/alg-sort-x-merge.md)

归并排序是把问题拆分为小问题，通过解决小问题来解决最初的问题（注：这种算法叫分治法，即『分而治之、各个击破』），具体建议你看：[算法思想 - 分治算法](../../algorithm/alg-core-divide-and-conquer.md) 和 [算法思想 - 二分法](../../algorithm/alg-core-devide-two.md)。
...
> 数据库中查询的时间复杂度，是我们无法使用矩阵，转而使用二叉搜索树(BST)，具体请参考： [树 - 二叉搜索树(BST)](../../algorithm/alg-basic-tree-search.md)
...
- 这就是为什么引入B+树索引, 具体请参考这篇：[MySQL - 索引(B+树)](../sql-mysql/sql-mysql-b-tree.md)
...
- 建议你回顾这篇文章：[线性表(散列) - 哈希表](../../algorithm/alg-basic-hashtable.md)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-2.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-4.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-3.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-5.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-6.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-7.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-8.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-9.png)
...
- 如果我们仅分析一个特定类型的计划（例如左深树 left-deep tree，参考)，我们得到 n\*2^n 而不是 3^n。
  ...
  - ![](https://www.pdai.tech/images/db/sb-sql-learn-10.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-11.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-12.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-13.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-14.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-15.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-16.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-17.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-18.png)
...
![](https://www.pdai.tech/images/db/sb-sql-learn-19.png)
...
如果你想很好地了解数据库，我推荐这篇研究论文：[Architecture of a Database System](https://dsf.berkeley.edu/papers/fntdb07-architecture.pdf)，中文版本（[这里](http://dblab.xmu.edu.cn/sites/default/files/files/linziyu-Architecture%20of%20a%20Database%20System(Chinese%20Version)-ALL.pdf)）对数据库有很好的介绍（共110页），而且非计算机专业人士也能读懂。
