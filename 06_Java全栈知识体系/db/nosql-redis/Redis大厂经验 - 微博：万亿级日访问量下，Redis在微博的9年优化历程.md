...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-1.png)

### 业务&规模&挑战

![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-2.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-3.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-4.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-5.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-6.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-7.png)

![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-8.png)

上面还有一个BCP，是因为当初我们在做这一套的时候，实际上是想在整个微博推广。

去年比特币特别火，我们也想通过购买比特币的方式，在内部通过机器的资源或者内部开源的一些东西来做等价物质的转换，然后来应用这个服务，但是最终这个计划没有具体落地。

![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-9.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-10.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-11.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-12.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-13.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-14.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-15.png)

以上是我们的设计思路，一是能支持在线扩缩容，二是支持多语言的访问，因为我们是要对整个公司进行推广的，而不是说只对一个部门，所以为了推广方便我们必须有这种功能，三是对服务化特性的需求。

![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-16.png)

![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-17.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-18.png)

- **Redis存储方面**：还是沿用我们内部改造的Redis版本，相对之前线上的版本，这次我们新增了官方比如Mememory，内存编码的优化，以及内部新增的一些新的功能。

![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-19.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-weibo-20.png)
...
- [原文地址](https://mp.weixin.qq.com/s?__biz=Mzg4NzU1MzIzMA==&mid=2247528094&idx=1&sn=e4416e3e13194a64319dd88d4b541d52&source=41#wechat_redirect)
