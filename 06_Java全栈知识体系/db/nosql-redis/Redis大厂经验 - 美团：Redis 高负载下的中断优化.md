...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-1.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-2.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-3.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-4.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-5.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-6.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-7.png)
...
通过霸爷的[一篇文章](http://blog.yufeng.info/archives/2037)，我们在测试环境做了测试，发现测试环境的中断确实有集中在CPU 0的情况，下面使用systemtap诊断测试环境软中断分布的方法:
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-8.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-9.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-10.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-11.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-12.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-13.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-14.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-mt-hc-15.png)

## 参考文档

- [Intel 官方文档](https://community.intel.com/t5/Ethernet-Products/bd-p/ethernet-products)
- [Redhat 官方文档](https://access.redhat.com/sites/default/files/attachments/20150325_network_performance_tuning.pdf)
