...
> Redis实战中包含开发，集群 和 运维，Redis用的好不好，如何让它更好，这是运维要做的；本文主要在 **Redis自身状态及命令**，**可视化监控工具**，以及**Redis监控体系**等方面帮助你构建对redis运维/监控体系的认知，它是性能优化的前提。@pdai
...
![](https://www.pdai.tech/images/db/redis/redis-stat-1.png)

和web模式

![](https://www.pdai.tech/images/db/redis/redis-stat-2.png)
...
![](https://www.pdai.tech/images/db/redis/redis-live-1.png)

访问http://192.168.99.100:8888/index.html

### redmon

> [redmon](https://github.com/steelThread/redmon)提供了cli、admin的web界面，同时也能够实时监控redis
...
![](https://www.pdai.tech/images/db/redis/redis-redmon-1.png)

cli

![](https://www.pdai.tech/images/db/redis/redis-redmon-2.png)

动态更新配置

![](https://www.pdai.tech/images/db/redis/redis-redmon-3.png)

### redis_exporter

> [redis_exporter](https://github.com/oliver006/redis_exporter)为Prometheus提供了redis指标的exporter，支持Redis 2.x, 3.x, 4.x, 5.x, and 6.x，配合Prometheus以及grafana的Prometheus Redis插件，可以在grafana进行可视化及监控

运行实例图

![](https://www.pdai.tech/images/db/redis/redis-export-1.png)

![](https://www.pdai.tech/images/db/redis/redis-export-2.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-monitor-2.png)
