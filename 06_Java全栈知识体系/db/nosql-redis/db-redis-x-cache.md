...
> Redis最常用的一个场景就是作为缓存，本文主要探讨Redis作为缓存，在实践中可能会有哪些问题？比如一致性, 穿击, 穿透, 雪崩, 污染等。@pdai
...
![](https://www.pdai.tech/images/db/redis/db-redis-cache-1.jpg)
...
![](https://www.pdai.tech/images/db/redis/db-redis-cache-2.png)

![](https://www.pdai.tech/images/db/redis/db-redis-cache-3.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-cache-4.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-cache-5.png)
