...
![](https://www.pdai.tech/images/db/redis/db-redis-sub-3.svg)
...
![](https://www.pdai.tech/images/db/redis/db-redis-sub-4.svg)
...
![](https://www.pdai.tech/images/db/redis/db-redis-sub-9.svg)

- **订阅**

如果这时客户端 client10086 执行 `PSUBSCRIBE broadcast.list.*` ， 那么 pubsub_patterns 链表将被更新成这样：

![](https://www.pdai.tech/images/db/redis/db-redis-sub-10.svg)
