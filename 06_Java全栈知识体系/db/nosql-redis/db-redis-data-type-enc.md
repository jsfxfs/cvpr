...
> 在学习完[底层数据结构](db-redis-x-redis-ds.md)之后，我们终于可以结合前文内容阐述redis对象及编码之间的关系了。@pdai

## redis对象与编码(底层结构)对应关系引入

在对[对象机制详解](db-redis-x-redis-object.md) 和 [底层数据结构](db-redis-x-redis-ds.md) 有了初步认识之后，我们便可以继续理解它们是怎么对应的：

![](https://www.pdai.tech/images/db/redis/db-redis-object-2-4.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-object-4.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-ds-x-21.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-ds-x-22.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-ds-x-23.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-object-9.png)

当使用 hashtable 编码时，上面命令存储如下：

![](https://www.pdai.tech/images/db/redis/db-redis-x-object-10.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-ds-x-24.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-object-11.png)

```bash
SADD Dfruits "apple" "banana" "cherry"
```

![](https://www.pdai.tech/images/db/redis/db-redis-x-object-12.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-ds-x-25.png)

然后是编码为SKIPLIST时, 有序集合的内存布局如下:

![](https://www.pdai.tech/images/db/redis/db-redis-ds-x-26.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-x-object-13.png)

![](https://www.pdai.tech/images/db/redis/db-redis-x-object-14.png)
