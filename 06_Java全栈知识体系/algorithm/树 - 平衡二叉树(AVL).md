...
![](https://www.pdai.tech/images/alg/alg-tree-avl-1.jpg)

上面的两张图片，左边的是AVL树，它的任何节点的两个子树的高度差别都<=1；而右边的不是AVL树，因为7的两颗子树的高度相差为2(以2为根节点的树的高度是3，而以8为根节点的树的高度是1)。

> 动画效果请参考 [AVL Tree](https://www.cs.usfca.edu/~galles/visualization/AVLtree.html)

![](https://www.pdai.tech/images/alg/alg-tree-avl-0.png)
...
![](https://www.pdai.tech/images/alg/alg-tree-avl-2.jpg)

上图中的4棵树都是"失去平衡的AVL树"，从左往右的情况依次是: LL、LR、RL、RR。除了上面的情况之外，还有其它的失去平衡的AVL树，如下图:

![](https://www.pdai.tech/images/alg/alg-tree-avl-3.jpg)
...
![](https://www.pdai.tech/images/alg/alg-tree-avl-4.jpg)
...
![](https://www.pdai.tech/images/alg/alg-tree-avl-5.jpg)
...
![](https://www.pdai.tech/images/alg/alg-tree-avl-6.jpg)
...
![](https://www.pdai.tech/images/alg/alg-tree-avl-7.jpg)
...
![](https://www.pdai.tech/images/alg/alg-tree-avl-test-1.jpg)

2.02 添加1 添加1之后，AVL树失去平衡(LL)，此时需要对AVL树进行旋转(LL旋转)。旋转过程如下:

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-2.jpg)

2.03 添加4 添加4不会破坏AVL树的平衡性。

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-3.jpg)

2.04 添加5 添加5之后，AVL树失去平衡(RR)，此时需要对AVL树进行旋转(RR旋转)。旋转过程如下:

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-4.jpg)

2.05 添加6 添加6之后，AVL树失去平衡(RR)，此时需要对AVL树进行旋转(RR旋转)。旋转过程如下:

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-5.jpg)

2.06 添加7 添加7之后，AVL树失去平衡(RR)，此时需要对AVL树进行旋转(RR旋转)。旋转过程如下:

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-6.jpg)

2.07 添加16 添加16不会破坏AVL树的平衡性。

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-7.jpg)

2.08 添加15 添加15之后，AVL树失去平衡(RR)，此时需要对AVL树进行旋转(RR旋转)。旋转过程如下:

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-8.jpg)

2.09 添加14 添加14之后，AVL树失去平衡(RL)，此时需要对AVL树进行旋转(RL旋转)。旋转过程如下:

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-9.jpg)

2.10 添加13 添加13之后，AVL树失去平衡(RR)，此时需要对AVL树进行旋转(RR旋转)。旋转过程如下

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-10.jpg)

2.11 添加12 添加12之后，AVL树失去平衡(LL)，此时需要对AVL树进行旋转(LL旋转)。旋转过程如下:

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-11.jpg)

2.12 添加11 添加11之后，AVL树失去平衡(LL)，此时需要对AVL树进行旋转(LL旋转)。旋转过程如下:

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-12.jpg)

2.13 添加10 添加10之后，AVL树失去平衡(LL)，此时需要对AVL树进行旋转(LL旋转)。旋转过程如下:

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-13.jpg)

2.14 添加8 添加8不会破坏AVL树的平衡性。

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-14.jpg)

2.15 添加9 但是添加9之后，AVL树失去平衡(LR)，此时需要对AVL树进行旋转(LR旋转)。旋转过程如下:

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-15.jpg)

3. 打印树的信息

输出下面树的信息:

![](https://www.pdai.tech/images/alg/alg-tree-avl-test-16.jpg)
...
![](https://www.pdai.tech/images/alg/alg-tree-avl-test-17.jpg)
