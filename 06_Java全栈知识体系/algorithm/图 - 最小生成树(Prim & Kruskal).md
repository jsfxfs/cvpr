...
> Kruskal算法是从最小权重边着手，将森林里的树逐渐合并；prim算法是从顶点出发，在根结点的基础上建起一棵树。@pdai
...
![](https://www.pdai.tech/images/alg/alg-graph-min-tree-0.png)
...
![](https://www.pdai.tech/images/alg/alg-graph-min-tree-1.png)
...
![](https://www.pdai.tech/images/alg/alg-graph-min-tree-2.png)
