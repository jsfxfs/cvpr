...
> 一致性Hash算法是个经典算法，Hash环的引入是为解决`单调性(Monotonicity)`的问题；虚拟节点的引入是为了解决`平衡性(Balance)`问题。@pdai
...
![](https://www.pdai.tech/images/alg/alg-dist-hash-1.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dist-hash-2.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dist-hash-3.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dist-hash-4.jpg)

### 删除节点

假设cache3服务器宕机，这时候需要从集群中将其摘除。那么，之前存储再c3上的k1，将会顺时针寻找距离它最近的一个节点，也就是c1节点，这样，k1就会存储到c1上了，看一看下下面的图，比较清晰。

![](https://www.pdai.tech/images/alg/alg-dist-hash-5.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dist-hash-6.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dist-hash-7.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dist-hash-9.png)
