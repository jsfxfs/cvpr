...
![](https://www.pdai.tech/images/alg/alg-sort-radix-1.jpg)
...
![](https://www.pdai.tech/images/alg/alg-sort-radix-2.jpg)

- 接着是根据桶数组buckets[]来进行排序。假设将排序后的数组存在output[]中；找出output[]和buckets[]之间的联系就可以对数据进行排序了。

![](https://www.pdai.tech/images/alg/alg-sort-radix-3.jpg)
