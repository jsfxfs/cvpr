...
> 关键路径在项目管理计算工期等方面有广泛等应用，提升工期就是所见缩减所有关键路径上的工期，并且在实现时需要应用到之前拓扑排序的算法(前提: 有向无环图，有依赖关系)。@pdai
...
![](https://www.pdai.tech/images/alg/alg-graph-aoe-0.png)

- etv从左向右推导

![](https://www.pdai.tech/images/alg/alg-graph-aoe-1.png)

- ltv从右向左推导

![](https://www.pdai.tech/images/alg/alg-graph-aoe-2.png)

- ete: 活动最早开工时间需要和etv事件最早发生时间结合

![](https://www.pdai.tech/images/alg/alg-graph-aoe-3.png)

- lte: 活动最晚开工时间需要和ltv事件最晚发生时间结合(都是倒序获得)

![](https://www.pdai.tech/images/alg/alg-graph-aoe-4.png)

> 推演的步骤具体可以参考 [这里](https://www.cnblogs.com/ssyfj/p/9496969.html)
