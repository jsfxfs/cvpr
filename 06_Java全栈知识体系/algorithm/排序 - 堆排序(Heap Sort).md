...
> 堆排序是指利用堆这种数据结构所设计的一种排序算法。堆是一个近似完全二叉树的结构，并同时满足堆积的性质：即子结点的键值或索引总是小于（或者大于）它的父节点。@pdai
...
![](https://www.pdai.tech/images/alg/alg-sort-heap-1.jpg)
...
![](https://www.pdai.tech/images/alg/alg-sort-heap-2.jpg)
...
![](https://www.pdai.tech/images/alg/alg-sort-heap-7.jpg)
...
![](https://www.pdai.tech/images/alg/alg-sort-heap-8.jpg)
...
本文主要参考至 https://www.cnblogs.com/skywang12345/p/3602162.html, 在此基础上做了内容的增改。