...
> Paxos算法是Lamport宗师提出的一种基于消息传递的分布式一致性算法，使其获得2013年图灵奖。自Paxos问世以来就持续垄断了分布式一致性算法，Paxos这个名词几乎等同于分布式一致性, 很多分布式一致性算法都由Paxos演变而来。@pdai
...
![](https://www.pdai.tech/images/alg/alg-dst-paxos-3.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dst-paxos-4.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dst-paxos-5.jpg)

实例2中P 3.1没有被多数派Accept(只有S3 Accept)，但是被P 4.5学习到，P 4.5将自己的Value由Y替换为X，Accept(X)。

![](https://www.pdai.tech/images/alg/alg-dst-paxos-6.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dst-paxos-7.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dst-paxos-8.jpg)
