...
> 希尔排序(Shell Sort)是插入排序的一种，它是针对直接插入排序算法的改进。@pdai
...
![](https://www.pdai.tech/images/alg/alg-sort-shell-3.jpg)
...
本文主要参考至 https://www.cnblogs.com/skywang12345/p/3597597.html, 在此基础上做了内容的增改。