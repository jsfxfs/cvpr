...
- [树 - 平衡二叉树(AVL)](alg-basic-tree-balance.md)
...
- [树 - 红黑树(R-B Tree)](alg-basic-tree-redblack.md)
  - 红黑树（Red Black Tree） 是一种自平衡二叉查找树，是在计算机科学中用到的一种数据结构，典型的用途是实现关联数组，是平衡二叉树和AVL树的折中。
- [树 - 哈夫曼树](alg-basic-tree-hafman.md)
  - 哈夫曼又称最优二叉树, 是一种带权路径长度最短的二叉树。
- [树 - 前缀树(Trie)](alg-basic-tree-trie.md)
...
- [图 - 基础和Overview](alg-basic-graph.md)
  - 图(Graph)是由顶点和连接顶点的边构成的离散结构。在计算机科学中，图是最灵活的数据结构之一，很多问题都可以使用图模型进行建模求解。例如: 生态环境中不同物种的相互竞争、人与人之间的社交与关系网络、化学上用图区分结构不同但分子式相同的同分异构体、分析计算机网络的拓扑结构确定两台计算机是否可以通信、找到两个城市之间的最短路径等等。
- [图 - 遍历(BFS & DFS)](alg-basic-graph-bfs-dfs.md)
  - 图的深度优先搜索(Depth First Search)，和树的先序遍历比较类似; 广度优先搜索算法(Breadth First Search)，又称为"宽度优先搜索"或"横向优先搜索"
- [图 - 最小生成树(Prim & Kruskal)](alg-basic-graph-min-tree.md)
  - Kruskal算法是从最小权重边着手，将森林里的树逐渐合并；prim算法是从顶点出发，在根结点的基础上建起一棵树
- [图 - 最短路径(Dijkstra & Frolyd)](alg-basic-graph-min-distance.md)
  - 最短路径有着广泛的应用，比如地图两点间距离计算，公交查询系统，路由选择等
- [图 - 拓扑排序(Topological sort)](alg-basic-graph-topo-sort.md)
  - 拓扑排序主要用来解决有向图中的依赖解析(dependency resolution)问题
- [图 - AOE & 关键路径](alg-basic-graph-aoe.md)
  - 关键路径在项目管理计算工期等方面有广泛等应用，提升工期就是所见缩减所有关键路径上的工期，并且在实现时需要应用到之前拓扑排序的算法(前提: 有向无环图，有依赖关系)

## 入门推荐

- 强烈推荐用动画学习算法 [Data Structure Visualizations](https://www.cs.usfca.edu/~galles/visualization/Algorithms.html)
- 推荐一个学习数据结构的英文网站 [Java Point - DS](https://www.javatpoint.com/data-structure-tutorial)
- 推荐Github上java算法集合 [TheAlgorithms - Java](https://github.com/TheAlgorithms/Java)
- 推荐@skywang12345写的数据结构 [skywang12345 - DS](https://www.cnblogs.com/skywang12345/p/3603935.html)
- 推荐@QG-whz数据结构图画的好(本章节中有部分图源于这位作者) [QG-whz](https://www.cnblogs.com/QG-whz/p/5170147.html)
- 推荐@亦海数据结构的文章，写的很清晰 [亦海 - DS](https://www.cnblogs.com/lisen10/category/1415992.html)

## 进阶推荐

- 首推@July结构之法 算法之道 [July - 结构之法 算法之道](https://blog.csdn.net/v_JULY_v)
