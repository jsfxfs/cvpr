...
> 数组和链表都是线性存储结构的基础，栈和队列都是线性存储结构的应用。@pdai
...
![](https://www.pdai.tech/images/alg/alg-stack-1.png)
...
![](https://www.pdai.tech/images/alg/alg-queue-1.png)
...
[《Java - Stack & Queue 源码解析》](../java/collection/java-collection-Queue&Stack.md)
