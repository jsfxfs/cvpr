...
> 朴素的字符串匹配算法又称为**暴力匹配算法**（Brute Force Algorithm），最为简单的字符串匹配算法。 @pdai
...
![](https://www.pdai.tech/images/alg/alg-domain-char-bf-2.png)
...
![](https://www.pdai.tech/images/alg/alg-domain-char-bf-1.png)
