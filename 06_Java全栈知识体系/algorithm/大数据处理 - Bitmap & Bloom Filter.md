...
![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-0.png)
...
![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-1.png)
...
![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-a-1.png)

那么，对于所有的k个HASH函数，都没有把这个位设置为1的概率是

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-a-2.png)

如果我们已经插入了n个元素，那么对于一个给定的位，这个位仍然是0的概率是

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-a-3.png)

那么，如果插入n个元素之后，这个位是1的概率是

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-a-4.png)

如果对一个特定的元素存在误报，那么这个元素的经过HASH函数所得到的k个索引全部都是1，概率也就是

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-a-5.png)

根据常数e的定义，可以近似的表示为:

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-a-6.png)
...
![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-b-1.png)
...
![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-b-2.png)
...
![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-c-1.png)

个集合。m位的位数组共有2m个不同的组合，进而可以推出，m位的位数组可以表示

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-c-2.png)

个集合。全集中n个元素的集合总共有

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-c-3.png)

个，因此要让m位的位数组能够表示所有n个元素的集合，必须有

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-c-4.png)

即:

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-c-5.png)
...
![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-c-6.png)
...
![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-d-1.png)

我们先计算第i个Counter被增加j次的概率，其中n为集合元素个数，k为哈希函数个数，m为Counter个数(对应着原来位数组的大小):

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-d-2.png)

上面等式右端的表达式中，前一部分表示从nk次哈希中选择j次，中间部分表示j次哈希都选中了第i个Counter，后一部分表示其它nk – j次哈希都没有选中第i个Counter。因此，第i个Counter的值大于j的概率可以限定为:

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-d-3.png)

上式第二步缩放中应用了估计阶乘的斯特林公式:

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-d-4.png)

在Bloom Filter概念和原理一文中，我们提到过k的最优值为(ln2)m/n，现在我们限制k ≤ (ln2)m/n，就可以得到如下结论:

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-d-5.png)

如果每个Counter分配4位，那么当Counter的值达到16时就会溢出。这个概率为:

![](https://www.pdai.tech/images/alg/alg-dst-bloomfilter-d-6.png)
