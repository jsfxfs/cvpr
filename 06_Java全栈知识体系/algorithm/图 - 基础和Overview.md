...
> 图(Graph)是由顶点和连接顶点的边构成的离散结构。在计算机科学中，图是最灵活的数据结构之一，很多问题都可以使用图模型进行建模求解。例如: 生态环境中不同物种的相互竞争、人与人之间的社交与关系网络、化学上用图区分结构不同但分子式相同的同分异构体、分析计算机网络的拓扑结构确定两台计算机是否可以通信、找到两个城市之间的最短路径等等。@pdai
...
![](https://www.pdai.tech/images/alg/alg-graph-store-1.png)
...
![](https://www.pdai.tech/images/alg/alg-graph-store-2.png)
...
![](https://www.pdai.tech/images/alg/alg-graph-store-3.jpg)
...
![](https://www.pdai.tech/images/alg/alg-graph-store-4.jpg)

- `带权图`

对于带权值的网图，可以在边表结点定义中再增加一个weight的数据域，存储权值信息即可，如下图所示。

![](https://www.pdai.tech/images/alg/alg-graph-store-5.jpg)
