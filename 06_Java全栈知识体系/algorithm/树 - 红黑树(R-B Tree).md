...
> 红黑树（Red Black Tree） 是一种自平衡二叉查找树，是在计算机科学中用到的一种数据结构，典型的用途是实现关联数组，是平衡二叉树和AVL树的折中。@pdai

提示

红黑树的讲解在[JDK TreeMap&TreeSet源码解读](../java/collection/Map - TreeSet & TreeMap 源码解析.md)中有详细的展示 。这里再补充一些其它内容。
