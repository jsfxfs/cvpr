...
> Paxos是出了名的难懂，而Raft正是为了探索一种更易于理解的一致性算法而产生的。它的首要设计目的就是易于理解，所以在选主的冲突处理等方式上它都选择了非常简单明了的解决方案。@pdai

## 推荐阅读

提示

强烈推荐通过如下资料学习raft。 @pdai

- [raft.github.io](https://raft.github.io/)

这里面有一个Raft Visualization:

![](https://www.pdai.tech/images/alg/alg-dst-raft-x1.png)
...
![](https://www.pdai.tech/images/alg/alg-dst-raft-2.jpg)

Follower只响应其他服务器的请求。如果Follower超时没有收到Leader的消息，它会成为一个Candidate并且开始一次Leader选举。收到大多数服务器投票的Candidate会成为新的Leader。Leader在宕机之前会一直保持Leader的状态。

![](https://www.pdai.tech/images/alg/alg-dst-raft-3.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dst-raft-5.jpg)

某些Followers可能没有成功的复制日志，Leader会无限的重试 AppendEntries RPC直到所有的Followers最终存储了所有的日志条目。

日志由有序编号(log index)的日志条目组成。每个日志条目包含它被创建时的任期号(term)，和用于状态机执行的命令。如果一个日志条目被复制到大多数服务器上，就被认为可以提交(commit)了。

![](https://www.pdai.tech/images/alg/alg-dst-raft-6.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dst-raft-7.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dst-raft-8.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dst-raft-9.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dst-raft-10.jpg)
...
![](https://www.pdai.tech/images/alg/alg-dst-raft-11.jpg)

Raft与Multi-Paxos的不同:

![](https://www.pdai.tech/images/alg/alg-dst-raft-12.jpg)
