...
> 将两个的有序数列合并成一个有序数列，我们称之为"归并"。归并排序(Merge Sort)就是利用归并思想对数列进行排序。@pdai
...
![](https://www.pdai.tech/images/alg/alg-sort-merge-1.jpg)
...
![](https://www.pdai.tech/images/alg/alg-sort-merge-2.jpg)
...
![](https://www.pdai.tech/images/alg/alg-sort-merge-3.jpg)
...
本文主要参考至 https://www.cnblogs.com/skywang12345/p/3602369.html, 在此基础上做了内容的增改。