...
> MapStruct是一款非常实用Java工具，主要用于解决对象之间的拷贝问题，比如PO/DTO/VO/QueryParam之间的转换问题。区别于BeanUtils这种通过反射，它通过编译器编译生成常规方法，将可以很大程度上提升效率。全面的官方手册可以参考[官方文档PDF](https://mapstruct.org/documentation/stable/reference/pdf/mapstruct-reference-guide.pdf)。@pdai
...
![](https://www.pdai.tech/images/develop/package/package-mapstrcut-9.png)
...
![](https://www.pdai.tech/images/develop/package/package-mapstrcut-10.png)
...
一般特性和例子最好直接[参考官网例子](https://github.com/mapstruct/mapstruct-examples)， 这里会差异化的体现一些常见的用法。@pdai
...
在了解基本的MapStruct使用之后，我们将从多个角度来深入理解MapStruct这个工具。@pdai

### IntelliJ IDEA 中对MapStruct的支持如何？

> 通常来说IDE对于MapStruct这类工具的支持体现在两方面，一个是Maven的集成，另一个是编辑时的提示（Hit）； 相关的支持可以[参考官网](https://mapstruct.org/documentation/ide-support/)。@pdai
...
![](https://www.pdai.tech/images/develop/package/package-mapstrcut-1.gif)

- 编辑器支持：连接跳转

![](https://www.pdai.tech/images/develop/package/package-mapstrcut-2.gif)

- 编辑器支持：查找使用方式

![](https://www.pdai.tech/images/develop/package/package-mapstrcut-3.png)
...
![](https://www.pdai.tech/images/develop/package/package-mapstrcut-4.png)

- 快速修复

![](https://www.pdai.tech/images/develop/package/package-mapstrcut-5.png)
...
![](https://www.pdai.tech/images/develop/package/package-mapstrcut-6.png)

- 1000次

![](https://www.pdai.tech/images/develop/package/package-mapstrcut-7.png)

- 10次

![](https://www.pdai.tech/images/develop/package/package-mapstrcut-8.png)
...
更多测试对比可以参考[这里](https://www.cnblogs.com/zhaoyanghoo/p/5722113.html)

### 和MapStruct类似框架的对比？

> 我们再看下是否有其它类似的框架呢？这里主要来源[这篇文章](https://www.baeldung.com/java-performance-mapping-frameworks)
...
![](https://www.pdai.tech/images/develop/package/package-mapstrcut-11.png)
...
- [官方文档PDF](https://mapstruct.org/documentation/stable/reference/pdf/mapstruct-reference-guide.pdf)
