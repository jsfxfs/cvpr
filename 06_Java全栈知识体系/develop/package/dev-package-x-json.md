...
- [JSON 在线解析](http://c.runoob.com/front-end/53)

![](https://www.pdai.tech/images/develop/package/dev-package-json-3.png)
...
![](https://www.pdai.tech/images/develop/package/dev-package-json-1.png)

- JSON反序列化性能

![](https://www.pdai.tech/images/develop/package/dev-package-json-2.png)

更多请参考： [Java几种常用JSON库性能比较](https://www.xncoding.com/2018/01/09/java/jsons.html)
...
- [Fastjson Github](https://github.com/alibaba/fastjson) 看这里
...
- [官方例子 - BeanToArray_cn](https://github.com/alibaba/fastjson/wiki/BeanToArray_cn)
...
- [fastjson远程代码执行漏洞技术分析与防护方案](http://blog.nsfocus.net/analysis-protection-fastjson-remote-code-execution-vulnerability/)
...
- [alibaba/fastjson](https://github.com/alibaba/fastjson/issues)
...
- [Jackson Github](https://github.com/FasterXML/jackson) 看这里
...
- [Gson用户指南（中文翻译）](https://www.jianshu.com/p/1e20b28c39d1)看这里
