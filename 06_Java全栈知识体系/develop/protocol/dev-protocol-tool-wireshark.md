...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-5.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-6.png)

- **封包详细信息** (Packet Details Pane)

这个面板是我们最重要的，用来查看协议中的每一个字段。

![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-7.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-2.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-3.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-4.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-8.png)

停止抓包后，我们可以选择保存抓取到的数据包。文件——> 另存为——>选择一个存储路径，然后就保存为后缀为 .pcap 格式的文件了，可以双击直接用wireshark打开。

![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-9.png)
...
详解请[参考前文](dev-protocol-tcpip.md)

![](https://www.pdai.tech/images/develop/network/dev-network-tcpip-4.jpg)

> 注：以下例子来源于：https://blog.csdn.net/shengjie87/article/details/106095866, 同时我还推荐你看下这篇 [wireshark抓包分析——TCP/IP协议](https://sq.163yun.com/blog/article/193066493804396544?tag=M_tg_144_70)

### TCP 三次握手

因为建立了连接，所以wireshark抓到数据包了

![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-11.png)

- 当客户端向服务器发送请求连接的报文时：
  - Seq序列号=x（这时客户端的序列号为0）
  - SYN=1（表示发送连接请求）

![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-12.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-13.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-14.png)

### TCP 四次挥手

（这时我们将服务器也就是虚拟机关机，使得服务器主动要求断开连接，这时服务器和客户端身份对调）

![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-16.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-17.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-18.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-19.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-wireshark-20.png)
