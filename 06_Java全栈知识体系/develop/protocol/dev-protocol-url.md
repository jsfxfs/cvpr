...
> - **第二**，在此基础上介绍`浏览器渲染过程`，以及为`Web优化`提供基础。@pdai
...
> 这里主要贯穿下思路，DNS涉及相关其它知识点可以参考：[网络协议 - DNS 解析详解](dev-protocol-dns.md)
...
![](https://www.pdai.tech/images/develop/network/dev-network-url-1.png)
...
> 上一步找到IP之后，便可以开始建立TCP连接了，这里就是我们所说的TCP3次握手。详情可以参考：[网络协议 - TCP 协议详解](dev-protocol-tcpip.md)

![](https://www.pdai.tech/images/develop/network/dev-network-url-2.png)

### 发送HTTP请求

> 与服务器建立了连接后，就可以向服务器发起请求了。详情可以参考：[网络协议 - HTTP 协议详解](dev-protocol-http.md)

请求报文结构如下：

![](https://www.pdai.tech/images/develop/network/dev-network-url-3.png)

![](https://www.pdai.tech/images/develop/network/dev-network-url-4.png)

### 服务器处理请求

服务器端收到请求后的由web服务器（准确说应该是http服务器）处理请求，诸如Apache、Ngnix、IIS等。web服务器解析用户请求，知道了需要调度哪些资源文件，再通过相应的这些资源文件处理用户请求和参数，并调用数据库信息，最后将结果通过web服务器返回给浏览器客户端。

![](https://www.pdai.tech/images/develop/network/dev-network-url-5.png)

详情可以参考：[网络协议 - HTTP 协议详解](dev-protocol-http.md)

### 返回HTTP响应结果

服务器处理完请求后，就会发送响应结果。响应报文的结构如下：

![](https://www.pdai.tech/images/develop/network/dev-network-url-6.png)

响应结果中会有对应的HTTP状态码，可分为5类：

![](https://www.pdai.tech/images/develop/network/dev-network-url-7.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-url-8.png)

详情可以参考：[网络协议 - TCP 协议详解](dev-protocol-tcpip.md)

## 浏览器加载，解析和渲染

浏览器构成

![](https://www.pdai.tech/images/develop/network/dev-network-url-9.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-url-10.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-url-11.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-url-12.png)

#### 将dom树和cssom树合并，生成渲染树

- 浏览器会先从dom树的根节点开始遍历每个可见节点，找到其适配的CSS样式规则并应用。
- 将dom树与cssom树结合在一起，这就是渲染树。 ![](https://www.pdai.tech/images/develop/network/dev-network-url-13.png)
