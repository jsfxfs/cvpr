...
![](https://www.pdai.tech/images/develop/network/dev-network-udp-1.png)

## UDP的首部格式

在计算检验和时，**临时把“伪首部”和 UDP 用户数据报连接在一起。伪首部仅仅是为了计算检验和。**

![](https://www.pdai.tech/images/develop/network/dev-network-udp-2.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-udp-3.png)
