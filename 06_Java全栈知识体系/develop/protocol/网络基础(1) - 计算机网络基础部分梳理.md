...
> 思考再三，决定在网络系列增加网络基础的章节, 因为它对网络部分的知识体系构建有很大的帮助。**网络基础分三部分内容**，本文是**第一部分**主要来源于大学的课程《计算机网络(第五版)》知识点梳理，内容整理自[这里](https://www.cnblogs.com/googny/p/3682280.html), 但是作了调整和优化; 不得不说这本书作者谢希忍画的PPT还是挺棒的。 @pdai
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-1.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-2.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-3.jpg)

每一个数据段前面添加上首部构成分组。

![](https://www.pdai.tech/images/develop/network/dev-network-basic-4.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-5.jpg)

**传播时延** 电磁波在信道中需要传播一定的距离而花费的时间。

**信号传输速率**（即发送速率）和信号在信道上的传播速率是完全不同的概念。

![](https://www.pdai.tech/images/develop/network/dev-network-basic-6.jpg)

**处理时延** 交换结点为存储转发而进行一些必要的处理所花费的时间。

**排队时延** 结点缓存队列中分组排队所经历的时延。

![](https://www.pdai.tech/images/develop/network/dev-network-basic-7.jpg)

排队时延的长短往往取决于网络中当时的通信量。

每种时延产生的地方

![](https://www.pdai.tech/images/develop/network/dev-network-basic-8.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-9.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-10.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-11.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-12.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-13.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-14.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-15.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-16.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-17.jpg)

一个码片向量和该码片反码的向量的规格化内积值是 –1。

**CDMA 的工作原理**

![](https://www.pdai.tech/images/develop/network/dev-network-basic-18.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-20.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-21.jpg)

用控制字符进行帧定界的方法举例

![](https://www.pdai.tech/images/develop/network/dev-network-basic-22.jpg)

**2.透明传输**

![](https://www.pdai.tech/images/develop/network/dev-network-basic-23.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-24.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-25.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-26.jpg)
...
- 树形网：主要用于频分复用的宽带局域网。
  - ![](https://www.pdai.tech/images/develop/network/dev-network-basic-27.jpg)
  - ![](https://www.pdai.tech/images/develop/network/dev-network-basic-28.jpg)
...
- 在计算机的操作系统安装设备驱动程序。
- 实现以太网协议。
  - ![](https://www.pdai.tech/images/develop/network/dev-network-basic-50.jpg)
...
- ![](https://www.pdai.tech/images/develop/network/dev-network-basic-29.jpg)
...
- 二、以太网发送的数据都使用 曼彻斯特(Manchester)编码（**为什么使用曼彻斯特编码？**）
  ...
  - ![](https://www.pdai.tech/images/develop/network/dev-network-basic-30.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-31.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-32.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-33.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-34.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-35.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-36.jpg)
...
- 网桥只适合于用户数不太多(不超过几百个)和通信量不太大的局域网，否则有时还会因传播过多的广播信息而产生网络拥塞。这就是所谓的广播风暴。
  - ![](https://www.pdai.tech/images/develop/network/dev-network-basic-37.jpg)
...
- 这是为了避免产生转发的帧在网络中不断地兜圈子。
  - ![](https://www.pdai.tech/images/develop/network/dev-network-basic-38.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-39.jpg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-basic-40.jpg)

虚拟局域网使用的以太网帧格式

虚拟局域网协议允许在以太网的帧格式中插入一个 4 字节的标识符，称为 VLAN 标记(tag)，用来指明发送该帧的工作站属于哪一个虚拟局域网。

![](https://www.pdai.tech/images/develop/network/dev-network-basic-41.jpg)
