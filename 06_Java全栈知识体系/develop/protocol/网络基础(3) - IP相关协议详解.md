...
![](https://www.pdai.tech/images/develop/network/dev-network-ip-2.jpeg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-ip-3.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-ip-4.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-ip-5.jpeg)

ARP 实现由 IP 地址得到 MAC 地址。

![](https://www.pdai.tech/images/develop/network/dev-network-ip-6.jpeg)

每个主机都有一个 ARP 高速缓存，里面有本局域网上的各主机和路由器的 IP 地址到 MAC 地址的映射表。

如果主机 A 知道主机 B 的 IP 地址，但是 ARP 高速缓存中没有该 IP 地址到 MAC 地址的映射，此时主机 A 通过广播的方式发送 ARP 请求分组，主机 B 收到该请求后会发送 ARP 响应分组给主机 A 告知其 MAC 地址，随后主机 A 向其高速缓存中写入主机 B 的 IP 地址到 MAC 地址的映射。

![](https://www.pdai.tech/images/develop/network/dev-network-ip-7.png)

### 网际控制报文协议 ICMP

ICMP 是为了更有效地转发 IP 数据报和提高交付成功的机会。它封装在 IP 数据报中，但是不属于高层协议。

![](https://www.pdai.tech/images/develop/network/dev-network-ip-8.jpeg)

ICMP 报文分为差错报告报文和询问报文。

![](https://www.pdai.tech/images/develop/network/dev-network-ip-9.png)
...
> 这部分内容主要整理自：[掘金：IPv6, 作者：ZhongFuCheng3y](https://juejin.im/post/5a643958f265da3e303c9670)
...
![](https://www.pdai.tech/images/develop/network/dev-network-ip-11.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-ip-12.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-ip-13.png)

## IP与Mac之间关系

> 有了 IP 地址，为什么还要用 MAC 地址？这里转一篇知乎上的回答：[知乎](https://www.zhihu.com/question/21546408/answer/28155896)
...
![](https://www.pdai.tech/images/develop/network/dev-network-ip-14.png)
