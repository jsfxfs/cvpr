...
> 本文是理解 **网络基础的第二篇**，我觉的一定要有全局框架观，构建全局观时建议分三步：第一步，理解全局的网络层次；第二步，理解每一层次中的常见的网络设备及功能；第三步，理解每一层中的常见协议。在此基础上，将其它知识点放置在相应的层次（很多网络上的零散知识点是没法帮你构筑完整的知识体系的，推荐你完整的看一本关于网络的书籍来构筑基础）。@pdai
...
![](https://www.pdai.tech/images/develop/network/dev-network-protocol-12.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-protocol-13.jpeg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-protocol-14.jpeg)
...
![](https://www.pdai.tech/images/develop/network/dev-network-protocol-15.png)
...
![](https://www.pdai.tech/images/develop/network/dev-network-protocol-11.jpg)
