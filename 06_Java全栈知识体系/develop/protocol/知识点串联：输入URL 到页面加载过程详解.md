...
> 这里主要贯穿下思路，DNS涉及相关其它知识点可以参考：[网络协议 - DNS 解析详解](网络协议 - DNS 相关详解.md)
...
> 上一步找到IP之后，便可以开始建立TCP连接了，这里就是我们所说的TCP3次握手。详情可以参考：[网络协议 - TCP 协议详解](网络协议 - TCP 协议详解.md)

![](https://www.pdai.tech/images/develop/network/dev-network-url-2.png)

### 发送HTTP请求

> 与服务器建立了连接后，就可以向服务器发起请求了。详情可以参考：[网络协议 - HTTP 协议详解](网络协议 - HTTP 协议详解.md)
...
详情可以参考：[网络协议 - HTTP 协议详解](网络协议 - HTTP 协议详解.md)
...
详情可以参考：[网络协议 - TCP 协议详解](网络协议 - TCP 协议详解.md)
