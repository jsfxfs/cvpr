...
> 统一样式检查规范里，最为常用的统一样式工具是checkstyle插件，本文将介绍常用的统一风格的措施之**静态样式检查**。@pdai
...
![](https://www.pdai.tech/images/develop/ut/dev-qt-9.png)

- **配置生效**

配置生效及告警设置

![](https://www.pdai.tech/images/develop/ut/dev-qt-11.png)
...
![](https://www.pdai.tech/images/develop/ut/dev-qt-12.png)

- **测试配置的CheckStyle**

![](https://www.pdai.tech/images/develop/ut/dev-qt-13.png)