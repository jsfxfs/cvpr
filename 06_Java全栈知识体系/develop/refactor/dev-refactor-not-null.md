...
随手翻了下，[hutool IdcardUtil](https://gitee.com/loolly/hutool/blob/v5-dev/hutool-core/src/main/java/cn/hutool/core/util/IdcardUtil.java) 显然是交给调用者判断的。
...
![](https://www.pdai.tech/images/develop/refactor/dev-refactor-notnull-1.png)
...
- 更多Optional，可以看这篇： [Java 8 - Optional类](../../java/java8/java8-optional.md)
  - Optional类的意义
  - Optional类有哪些常用的方法
  - Optional举例贯穿所有知识点
  - 多重类嵌套Null值判断