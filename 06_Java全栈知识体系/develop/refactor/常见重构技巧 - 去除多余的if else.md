...
> 有非常多的重构方法来解决这个问题, 这里会列举很多方法，在实际应用中可能会根据场景进行一些调整；另外不要纠结这些例子中显而易见的缺陷（比如没用常量，没考虑多线程等等），而是把重心放在学习其中的思路上。@pdai
...
- 首先让我们回顾下什么是命令模式
  ...
  - 看这篇文章：[行为型 - 命令模式(Command)](../../dev-spec/pattern/行为型 - 命令模式(Command).md)
    ...
    ![](https://www.pdai.tech/images/pics/ae1b27b8-bc13-42e7-ac12-a2242e125499.png)
- Command接口
...
- 什么是策略模式？
  ...
  - 我们再复习下：[行为型 - 策略(Strategy)](../../dev-spec/pattern/行为型 - 策略(Strategy).md)
  ...
  ![](https://www.pdai.tech/images/pics/1fc969e4-0e7c-441b-b53c-01950d2f2be5.png)
- **Spring中需要注入资源重构？**
