...
> Shepherd API网关项目正式立项，我们的目标是为美团提供高性能、高可用、可扩展的统一API网关解决方案，让业务研发人员通过配置的方式即可对外开放功能和数据。
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-1.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-2.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-3.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-4.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-5.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-6.png)

**协议转换&服务调用**

API调用的最后一步，就是协议转换以及服务调用了。网关需要完成的工作包括：获取HTTP请求参数、Context本地参数，拼装后端服务参数，完成HTTP协议到后端服务的协议转换，调用后端服务获取响应结果并转换为HTTP响应结果。

![](https://www.pdai.tech/images/arch/gateway/gateway-mt-7.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-8.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-9.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-10.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-11.png)

#### 2.2.3 稳定性保障

Shepherd提供了一些常规的稳定性保障手段，来保证自身和后端服务的可用性。如下图所示：

![](https://www.pdai.tech/images/arch/gateway/gateway-mt-12.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-13.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-23.png)

**多维度告警**

有了全面的监控体系，自然少不了配套的告警机制，主要的告警能力包括：

![](https://www.pdai.tech/images/arch/gateway/gateway-mt-24.png)

#### 2.2.7 故障自愈

Shepherd服务端接入了弹性伸缩模块，可根据CPU等指标进行快速扩容、缩容。除此之外，还支持快速摘除问题节点，以及更细粒度的问题组件摘除。

![](https://www.pdai.tech/images/arch/gateway/gateway-mt-14.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-15.png)

**灰度中**：在Shepherd管理平台开启灰度功能，灰度SDK将灰度流量转发到网关服务，进行验证。

![](https://www.pdai.tech/images/arch/gateway/gateway-mt-16.png)

**灰度后**：通过灰度流量验证Shepherd上的API配置符合预期后再迁移。

![](https://www.pdai.tech/images/arch/gateway/gateway-mt-17.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-18.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-19.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-20.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-21.png)
...
![](https://www.pdai.tech/images/arch/gateway/gateway-mt-22.png)
...
- 作者：充泽、志洋、李敏等，均来自美团基础技术部-基础架构团队。
