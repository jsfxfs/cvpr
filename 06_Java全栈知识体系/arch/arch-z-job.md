...
> JDK内置的Timer, 现在很少被使用。更多内容和集成可以看：[SpringBoot集成定时任务 - Timer实现方式](../spring/springboot/springboot-x-task-timer.md)
...
> ScheduledExecutorService是基于线程池的实现方式。更多内容和集成可以看：[SpringBoot集成定时任务 - ScheduleExecutorService实现方式](../spring/springboot/springboot-x-task-executor-timer.md)
...
具体案例请看：[SpringBoot集成定时任务 - Netty HashedWheelTimer方式](../spring/springboot/springboot-x-task-hashwheeltimer-timer.md)

#### Spring Tasks

> Spring提供的schedule任务，更多内容和集成可以看：[SpringBoot集成定时任务 - Spring tasks实现方式](../spring/springboot/springboot-x-task-spring-task-timer.md)
...
> 来源[百度百科](https://baike.baidu.com/item/quartz/3643055), 官网地址：http://www.quartz-scheduler.org/；更多内容和集成可以看：[SpringBoot集成定时任务 - 基础quartz实现方式](../spring/springboot/springboot-x-task-quartz-timer.md)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-job-quartz-1.png)
...
> 常见的分布式任务的方案有：Quartz Cluster，XXL-Job，Elastic-Job等。@pdai: 综合**代码质量，License, 维护方，拓展性**等，选择的建议：
>
...
> Quartz 提供的持久化方式，更多内容和集成可以看： [SpringBoot集成定时任务 - 分布式quartz cluster方式](../spring/springboot/springboot-x-task-quartz-cluster-timer.md)
...
> XXL-JOB是一个分布式任务调度平台，其核心设计目标是开发迅速、学习简单、轻量级、易扩展。现已开放源代码并接入多家公司线上产品线，开箱即用。实现案例[SpringBoot集成定时任务 - 分布式xxl-job方式](../spring/springboot/springboot-x-task-xxl-job-timer.md)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-xxl-job-8.png)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-elasticjob-lite-1.png)

Elasticjob-lite的案例- [SpringBoot集成定时任务 - 分布式Elasticjob-lite方式](../spring/springboot/springboot-x-task-elastic-job-timer.md)

**ElasticJob-Cloud**： 采用自研 Mesos Framework 的解决方案，额外提供资源治理、应用分发以及进程隔离等功能。

![](https://www.pdai.tech/images/spring/springboot/springboot-elasticjob-cloud-1.png)
