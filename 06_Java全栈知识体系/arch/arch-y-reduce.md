...
> 在高并发环境下，**服务之间的依赖关系导致调用失败，解决的方式通常是: 限流->熔断->隔离->降级, 其目的是防止雪崩效应**。@pdai
...
![](https://www.pdai.tech/images/arch/arch-x-reduce-1.png)
...
![](https://www.pdai.tech/images/arch/arch-x-reduce-3.png)
...
![](https://www.pdai.tech/images/arch/arch-x-reduce-31.png)
...
![](https://www.pdai.tech/images/arch/arch-x-reduce-5.png)
...
![](https://www.pdai.tech/images/arch/arch-x-reduce-7.png)
