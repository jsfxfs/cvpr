...
> 20多年前，Peter Deutsch和James Gosling定义了分布式计算的8个谬误。这些是许多开发人员对分布式系统做出的错误假设。从长远来看，这些通常被证明是错误的，导致难以修复错误。**这篇文章从反面警示我们分布式系统需要注意的事项**。@pdai
...
- 作者：Victor Chircu
- 译者：February
- 原文地址：https://www.red-gate.com/simple-talk/blogs/the-eight-fallacies-of-distributed-computing/
- 译文地址：https://cloud.tencent.com/developer/article/1370391