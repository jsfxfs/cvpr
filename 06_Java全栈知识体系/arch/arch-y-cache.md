...
> **高并发实现的三板斧：缓存，限流和降级**。缓存在高并发系统中有者极其广阔的应用，需要重点掌握，本文重点介绍下缓存及其实现。@pdai
...
![](https://www.pdai.tech/images/arch/arch-x-cache-1.png)
...
![](https://www.pdai.tech/images/arch/arch-x-cache-2.png)
...
![](https://www.pdai.tech/images/arch/arch-x-cache-4.png)
...
![](https://www.pdai.tech/images/arch/arch-x-cache-5.png)
...
请参考：[分布式系统 - 分布式缓存及实现方案](arch-z-cache.md)
...
![](https://www.pdai.tech/images/arch/arch-x-cache-12.png)
...
![](https://www.pdai.tech/images/arch/arch-x-cache-13.png)
