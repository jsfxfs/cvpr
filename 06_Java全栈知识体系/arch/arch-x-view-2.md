...
> 技术框架（technological Framework）是整个或部分技术系统的可重用设计，表现为一组抽象构件及构件实例间交互的方法。于开发者而言，实际工作从通常采用的是分层模型，这里独立一个章节，总结经典的**七层逻辑架构**。@pdai

## 架构技术视角回顾

> 上个章节[架构 - 理解构架的视角](arch-x-view.md#%E5%BA%94%E7%94%A8%E6%8A%80%E6%9C%AF%E6%9E%B6%E6%9E%84)中已经站在不同角色视角理解了架构，我们再回顾下技术架构。
...
![](https://www.pdai.tech/images/arch/arch-x-overview-layer2.jpg)
