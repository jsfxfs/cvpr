...
> 为了方便读者更好地理解 Logan 系统是如何工作的，下图是简化后的 Logan 系统工作流程图。
...
![](https://www.pdai.tech/images/arch/log/log-logan-1.jpeg)
...
针对以上痛点问题，我们提出了建设 Logan 实时日志，旨在**提供统一的、高性能的实时日志服务，以解决美团现阶段不同业务系统想要日志上云**的需求。

### 1.4 Logan 实时日志是什么？

Logan 实时日志是服务于移动端 App、Web、小程序、IoT 等终端场景下的实时日志解决方案，旨在提供高扩展性、高性能、高可靠性的实时日志服务，包括日志采集、上传、加工、消费、投递、查询与分析等能力。

![](https://www.pdai.tech/images/arch/log/log-logan-2.jpeg)

## 2 设计实现

### 2.1 整体架构

![](https://www.pdai.tech/images/arch/log/log-logan-3.jpeg)
...
![](https://www.pdai.tech/images/arch/log/log-logan-4.jpeg)
...
![](https://www.pdai.tech/images/arch/log/log-logan-5.jpeg)

### 2.3 数据接入层

对于实时日志系统来讲，接入层需要满足以下几点要求：
...
![](https://www.pdai.tech/images/arch/log/log-logan-6.jpeg)

### 2.4 数据处理层

在数据处理框架的技术选型上，我们先后考虑了三种方案，分别是传统架构（Java 应用）、Storm 架构、Flink 架构，这三种方案在不同维度的对比数据如下：

![](https://www.pdai.tech/images/arch/log/log-logan-11.png)
...
![](https://www.pdai.tech/images/arch/log/log-logan-7.jpeg)
...
![](https://www.pdai.tech/images/arch/log/log-logan-8.jpeg)
...
![](https://www.pdai.tech/images/arch/log/log-logan-9.jpeg)

> Elasticsearch：是一个分布式的开源搜索和分析引擎，具有接入成本低、扩展性高和近实时性等优点，比较适合用来做大数据量的全文检索服务，例如日志查询等。具体可以看 [ElasticSearch知识体系详解](../../db/nosql-es/elasticsearch.md)
...
![](https://www.pdai.tech/images/arch/log/log-logan-12.png)
...
![](https://www.pdai.tech/images/arch/log/log-logan-10.jpeg)
...
- 作者：洪坤、徐博、陈成、少星等，均来自美团-基础技术部-前端技术中心。
- 版权声明：本文为「美团技术团队」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
- 原文链接：https://tech.meituan.com/2022/11/03/logan-real-time-log.html