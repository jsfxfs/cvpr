...
![](https://www.pdai.tech/images/arch/log/log-mt-log-1.png)
...
:::warning这里解释下 为什么记录操作日志的时候都绑定了一个 OrderNo，因为操作日志记录的是：某一个“时间”“谁”对“什么”做了什么“事情”。当查询业务的操作日志的时候，会查询针对这个订单的的所有操作，所以代码中加上了 OrderNo，记录操作日志的时候需要记录下操作人，所以传了操作人“小明”进来。 :::
...
![](https://www.pdai.tech/images/arch/log/log-mt-log-2.png)
...
![](https://www.pdai.tech/images/arch/log/log-mt-log-3.png)
...
![](https://www.pdai.tech/images/arch/log/log-mt-log-4.png)
...
![](https://www.pdai.tech/images/arch/log/log-mt-log-5.png)
...
![](https://www.pdai.tech/images/arch/log/log-mt-log-6.png)
...
![](https://www.pdai.tech/images/arch/log/log-mt-log-7.png)
...
![](https://www.pdai.tech/images/arch/log/log-mt-log-8.png)

看起来没有什么问题，但是使用 LogRecordAnnotation 的方法里面嵌套了另一个使用 LogRecordAnnotation 方法的时候，流程就变成下面的形式：

![](https://www.pdai.tech/images/arch/log/log-mt-log-9.png)
...
![](https://www.pdai.tech/images/arch/log/log-mt-log-10.png)
...
- 作者：站通，2020年加入美团，基础研发平台/研发质量及效率部工程师。
