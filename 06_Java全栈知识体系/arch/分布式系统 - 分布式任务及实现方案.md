...
> JDK内置的Timer, 现在很少被使用。更多内容和集成可以看：[SpringBoot集成定时任务 - Timer实现方式](../spring/springboot/-SpringBoot定时任务 - Timer实现方式.md)
...
> ScheduledExecutorService是基于线程池的实现方式。更多内容和集成可以看：[SpringBoot集成定时任务 - ScheduleExecutorService实现方式](../spring/springboot/SpringBoot定时任务 - ScheduleExecutorService实现方式.md)
...
具体案例请看：[SpringBoot集成定时任务 - Netty HashedWheelTimer方式](../spring/springboot/SpringBoot定时任务 - Netty HashedWheelTimer方式.md)

#### Spring Tasks

> Spring提供的schedule任务，更多内容和集成可以看：[SpringBoot集成定时任务 - Spring tasks实现方式](../spring/springboot/SpringBoot定时任务 - Spring Schedule实现方式.md)
...
> 来源[百度百科](https://baike.baidu.com/item/quartz/3643055), 官网地址：http://www.quartz-scheduler.org/；更多内容和集成可以看：[SpringBoot集成定时任务 - 基础quartz实现方式](../spring/springboot/SpringBoot定时任务 - 基础quartz实现方式.md)
...
> Quartz 提供的持久化方式，更多内容和集成可以看： [SpringBoot集成定时任务 - 分布式quartz cluster方式](../spring/springboot/SpringBoot定时任务 - 分布式quartz cluster方式.md)
...
> XXL-JOB是一个分布式任务调度平台，其核心设计目标是开发迅速、学习简单、轻量级、易扩展。现已开放源代码并接入多家公司线上产品线，开箱即用。实现案例[SpringBoot集成定时任务 - 分布式xxl-job方式](../spring/springboot/SpringBoot定时任务 - 分布式xxl-job方式.md)
...
Elasticjob-lite的案例- [SpringBoot集成定时任务 - 分布式Elasticjob-lite方式](../spring/springboot/SpringBoot定时任务 - 分布式elastic-job方式.md)
