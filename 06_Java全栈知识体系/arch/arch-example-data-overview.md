...
- [美团: 数据库高可用架构的演进与设想](arch-example-meituan-db-hp.md)
  - 本文介绍最近几年美团MySQL数据库高可用架构的演进过程，以及我们在开源技术基础上做的一些创新。同时，也和业界其它方案进行综合对比，了解业界在高可用方面的进展，和未来我们的一些规划和展望。
- [美团: 数据同步到仓库的架构实践](arch-example-meituan-db-binlog.md)
...
- [美团：外卖实时数仓建设实践](arch-example-meituan-data-cangchu.md)
...
- [美团：数据治理一体化实践之体系化建模](arch-example-meituan-data-zhili.md)
