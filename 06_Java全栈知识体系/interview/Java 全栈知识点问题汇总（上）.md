...
Java 全栈知识点问题汇总（上）, [Java 全栈知识点问题汇总（下）](Java 全栈知识点问题汇总（下）.md)。@pdai
...
Java 内存模型是个很复杂的规范，具体看[Java 内存模型详解](../java/jvm/JVM 基础 - Java 内存模型详解.md)。
...
- `workQueue` 用来保存等待被执行的任务的阻塞队列. 在JDK中提供了如下阻塞队列: 具体可以参考[JUC 集合: BlockQueue详解](../java/thread/JUC集合： BlockingQueue详解.md)
...
- 详情请参考: [JUC线程池: ThreadPoolExecutor详解](../java/thread/JUC线程池： ThreadPoolExecutor详解.md)
...
我们在[Java 并发 - 并发理论基础](../java/thread/Java 并发 - 理论基础.md#%E7%BA%BF%E7%A8%8B%E5%AE%89%E5%85%A8%E7%9A%84%E5%AE%9E%E7%8E%B0%E6%96%B9%E6%B3%95)总结过线程安全(是指广义上的共享资源访问安全性，因为线程隔离是通过副本保证本线程访问资源安全性，它不保证线程之间还存在共享关系的狭义上的安全性)的解决思路：
...
Raft算法你可以参看这篇文章[分布式算法 - Raft算法](../algorithm/分布式算法 - Raft算法.md)
