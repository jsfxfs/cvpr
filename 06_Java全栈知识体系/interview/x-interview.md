...
Java 全栈知识点问题汇总（上）, [Java 全栈知识点问题汇总（下）](x-interview-2.md)。@pdai
...
![](https://www.pdai.tech/images/java/java-basic-generic-4.png)

- 调用泛型方法语法格式

![](https://www.pdai.tech/images/java/java-basic-generic-5.png)
...
![](https://www.pdai.tech/images/java/java-basic-reflection-3.png)
...
![](https://www.pdai.tech/images/java/java-advanced-spi-8.jpg)
...
![ArrayList_base](https://www.pdai.tech/images/collection/ArrayList_base.png)
...
![HashMap_base](https://www.pdai.tech/images/collection/HashMap_base.png)
...
![](https://www.pdai.tech/images/java/java-collection-hashmap8.png)
...
Java 内存模型是个很复杂的规范，具体看[Java 内存模型详解](../java/jvm/java-jvm-jmm.md)。
...
![](https://www.pdai.tech/images/java/java-bingfa-2.png)

并行是指多个处理器或者是多核的处理器同时处理多个不同的任务。

![](https://www.pdai.tech/images/java/java-bingfa-1.png)

#### 线程有哪几种状态? 分别说明从一种状态到另一种状态转变有哪些方式?

![image](https://www.pdai.tech/images/pics/ace830df-9919-48ca-91b5-60b193f593d2.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-key-schronized-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-key-schronized-2.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-key-schronized-3.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-key-final-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-key-final-2.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-overview-1-u.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-overview-lock.png)
...
![image](https://www.pdai.tech/images/thread/java-thread-x-juc-overview-2.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-juc-executors-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-atomicinteger-unsafe.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-locksupport-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-readwritelock-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-concurrent-hashmap-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-juc-concurrentlinkedqueue-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-blocking-queue-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-blocking-deque-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-juc-futuretask-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-executors-1.png)
...
- `workQueue` 用来保存等待被执行的任务的阻塞队列. 在JDK中提供了如下阻塞队列: 具体可以参考[JUC 集合: BlockQueue详解](../java/thread/java-thread-x-juc-collection-BlockingQueue.md)
...
![](https://www.pdai.tech/images/thread/java-thread-x-executors-3.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-stpe-1.png)

ScheduledThreadPoolExecutor继承自 `ThreadPoolExecutor`:

- 详情请参考: [JUC线程池: ThreadPoolExecutor详解](../java/thread/java-thread-x-juc-executor-ThreadPoolExecutor.md)
...
![](https://www.pdai.tech/images/thread/java-thread-x-forkjoin-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-forkjoin-4.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-forkjoin-2.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-forkjoin-3.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-semaphore-1.png)
...
![](https://www.pdai.tech/images/thread/java-thread-x-juc-phaser-1.png)
...
我们在[Java 并发 - 并发理论基础](../java/thread/java-thread-x-theorty.md#%E7%BA%BF%E7%A8%8B%E5%AE%89%E5%85%A8%E7%9A%84%E5%AE%9E%E7%8E%B0%E6%96%B9%E6%B3%95)总结过线程安全(是指广义上的共享资源访问安全性，因为线程隔离是通过副本保证本线程访问资源安全性，它不保证线程之间还存在共享关系的狭义上的安全性)的解决思路：
...
![](https://www.pdai.tech/images/io/java-io-category-1.png)

- **字符流**

![](https://www.pdai.tech/images/io/java-io-category-2.png)
...
![](https://www.pdai.tech/images/pics/c9cfd600-bc91-4f3a-9f99-b42f88a5bb24.jpg)
...
![](https://www.pdai.tech/images/jvm/java-jvm-stack-2.png)
...
![](https://www.pdai.tech/images/jvm/java-jvm-stack-3.png)
...
![](https://www.pdai.tech/images/jvm/java-jvm-stack-1.png)
...
![](https://www.pdai.tech/images/java/java-11-1.png)
...
![image](https://www.pdai.tech/images/pics/185b9c49-4c13-4241-a848-fbff85c03a64.png)
...
![image](https://www.pdai.tech/images/pics/88ff46b3-028a-4dbb-a572-1f062b8b96d3.png)

- **读脏数据**

T1 修改一个数据，T2 随后读取这个数据。如果 T1 撤销了这次修改，那么 T2 读取的数据是脏数据。

![image](https://www.pdai.tech/images/pics/dd782132-d830-4c55-9884-cfac0a541b8e.png)

- **不可重复读**

T2 读取一个数据，T1 对该数据做了修改。如果 T2 再次读取这个数据，此时读取的结果和第一次读取的结果不同。

![image](https://www.pdai.tech/images/pics/c8d18ca9-0b09-441a-9a0c-fb063630d708.png)

- **幻影读**

T1 读取某个范围的数据，T2 在这个范围内插入新的数据，T1 再次读取这个范围的数据，此时读取的结果和和第一次读取的结果不同。

![image](https://www.pdai.tech/images/pics/72fe492e-f1cb-4cfc-92f8-412fb3ae6fec.png)
...
![](https://www.pdai.tech/images/db/mysql/db-mysql-sql-14.png)
...
![](https://www.pdai.tech/images/mysql/061c88c1-572f-424f-b580-9cbce903a3fe.png)
...
![](https://www.pdai.tech/images/db/mysql/db-mysql-index-1.png)
...
![](https://www.pdai.tech/images/db/mysql/db-mysql-mvcc-11.jpeg)
...
![](https://www.pdai.tech/images/db/mysql/db-mysql-mvcc-12.jpeg)

这时候版本链就是

![](https://www.pdai.tech/images/db/mysql/db-mysql-mvcc-13.jpeg)
...
![](https://www.pdai.tech/images/mysql/e130e5b8-b19a-4f1e-b860-223040525cf6.jpg)
...
![](https://www.pdai.tech/images/mysql/63c2909f-0c5f-496f-9fe5-ee9176b31aba.jpg)
...
![](https://www.pdai.tech/images/mysql/master-slave-proxy.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-object-2-3.png)
...
![](https://www.pdai.tech/images/db/redis/redis-x-rdb-4.jpg)
...
![](https://www.pdai.tech/images/db/redis/redis-x-rdb-1.png)
...
![](https://www.pdai.tech/images/db/redis/redis-x-aof-42.jpg)
...
如下图所示，我们先在 T0 时刻做了一次快照，然后又在 T0+t 时刻做了一次快照，在这期间，数据块 5 和 9 被修改了。如果在 t 这段时间内，机器宕机了，那么，只能按照 T0 时刻的快照进行恢复。此时，数据块 5 和 9 的修改值因为没有快照记录，就无法恢复了。 　　 ![](https://www.pdai.tech/images/db/redis/redis-x-rdb-2.jpg)
...
![](https://www.pdai.tech/images/db/redis/redis-x-aof-41.jpg)
...
![](https://www.pdai.tech/images/db/redis/redis-x-aof-4.jpg)
...
![](https://www.pdai.tech/images/db/redis/redis-x-aof-1.jpg)
...
![](https://www.pdai.tech/images/db/redis/redis-x-aof-3.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-trans-1.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-trans-2.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-copy-1.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-copy-2.jpg)
...
![](https://www.pdai.tech/images/db/redis/db-redis-copy-3.jpg)
...
![](https://www.pdai.tech/images/db/redis/db-redis-copy-4.jpg)
...
![](https://www.pdai.tech/images/db/redis/db-redis-sen-1.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-sen-6.jpg)
...
![](https://www.pdai.tech/images/db/redis/db-redis-sen-7.jpg)
...
![](https://www.pdai.tech/images/db/redis/db-redis-sen-2.jpg)
...
Raft算法你可以参看这篇文章[分布式算法 - Raft算法](../algorithm/alg-domain-distribute-x-raft.md)
...
![](https://www.pdai.tech/images/db/redis/db-redis-sen-3.jpg)
...
![](https://www.pdai.tech/images/db/redis/db-redis-sen-4.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-sen-5.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-event-1.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-event-2.png)

如下图所示，文件事件处理器有四个组成部分，它们分别是套接字、I/O多路复用程序、文件事件分派器以及事件处理器。

![](https://www.pdai.tech/images/db/redis/db-redis-event-3.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-event-4.png)
...
![](https://www.pdai.tech/images/db/redis/db-redis-sub-1.svg)

当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：

![](https://www.pdai.tech/images/db/redis/db-redis-sub-2.svg)
...
![](https://www.pdai.tech/images/db/redis/db-redis-sub-8.png)

- **基于模式(pattern)的发布/订阅**

下图展示了一个带有频道和模式的例子， 其中 tweet.shop.\* 模式匹配了 tweet.shop.kindle 频道和 tweet.shop.ipad 频道， 并且有不同的客户端分别订阅它们三个：

![](https://www.pdai.tech/images/db/redis/db-redis-sub-5.svg)

当有信息发送到 tweet.shop.kindle 频道时， 信息除了发送给 clientX 和 clientY 之外， 还会发送给订阅 tweet.shop.\* 模式的 client123 和 client256 ：

![](https://www.pdai.tech/images/db/redis/db-redis-sub-6.svg)

另一方面， 如果接收到信息的是频道 tweet.shop.ipad ， 那么 client123 和 client256 同样会收到信息：

![](https://www.pdai.tech/images/db/redis/db-redis-sub-7.svg)
...
![](https://www.pdai.tech/images/db/redis/redis-performance-2.jpeg)
...
![](https://www.pdai.tech/images/db/mongo/mongo-y-arch-2.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-x-usage-11.png)

#### MongoDB聚合的Map Reduce方式？

![](https://www.pdai.tech/images/db/mongo/mongo-x-usage-12.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-y-ds-3.jpg)
...
![](https://www.pdai.tech/images/db/mongo/mongo-y-page-1.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-x-checkpoint-1.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-z-rep-1.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-z-rep-5.png)

当主节点宕机后,两个从节点都会进行竞选，其中一个变为主节点，当原主节点恢复后，作为从节点加入当前的复制集群即可。

![](https://www.pdai.tech/images/db/mongo/mongo-z-rep-6.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-z-rep-7.png)

当主节点宕机时，将会选择从节点成为主，主节点修复后，将其加入到现有的复制集群中即可。

![](https://www.pdai.tech/images/db/mongo/mongo-z-rep-8.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-z-rep-9.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-z-shard-1.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-z-shard-2.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-z-shard-4.png)

这时候，各个shard 上的chunk数量就会不平衡。这时候，mongos中的一个组件balancer 就会执行自动平衡。把chunk从chunk数量最多的shard节点挪动到数量最少的节点。

![](https://www.pdai.tech/images/db/mongo/mongo-z-shard-5.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-z-shard-6.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-z-shard-7.png)

在使用片键做范围划分的系统中，拥有**相近分片键**的文档很可能存储在同一个数据块中，因此也会存储在同一个分片中。

- **哈希和范围的结合**

如下是基于X索引字段进行范围分片，但是随着X的增长，大于20的数据全部进入了Chunk C, 这导致了数据的不均衡。 ![](https://www.pdai.tech/images/db/mongo/mongo-z-shard-111.png)

这时对X索引字段建哈希索引：

![](https://www.pdai.tech/images/db/mongo/mongo-z-shard-112.png)
...
![](https://www.pdai.tech/images/db/mongo/mongo-y-doc-2.png)

![](https://www.pdai.tech/images/db/mongo/mongo-y-doc-2.gif)
...
![](https://www.pdai.tech/images/db/es/es-introduce-1-3.png)

#### ELK 技术栈的常见应用场景？

- 日志系统

![](https://www.pdai.tech/images/db/es/es-introduce-2-5.png)

增加数据源，和使用MQ

![](https://www.pdai.tech/images/db/es/es-introduce-2-6.png)

- Metric收集和APM性能监控

![](https://www.pdai.tech/images/db/es/es-introduce-2-7.png)
...
![](https://www.pdai.tech/images/db/es/es-agg-bucket-1.png)
...
![](https://www.pdai.tech/images/db/es/es-th-2-3.png)
...
![](https://www.pdai.tech/images/db/es/es-th-2-2.png)

文件的关系如下：

![](https://www.pdai.tech/images/db/es/es-th-3-2.jpeg)

#### ES内部读取文档是怎样的？如何实现的？

- **主分片或者副本分片检索文档的步骤顺序**：

![](https://www.pdai.tech/images/db/es/es-th-2-21.png)
...
![](https://www.pdai.tech/images/db/es/es-th-2-32.jpeg)
...
![](https://www.pdai.tech/images/db/es/es-th-2-4.png)
...
![](https://www.pdai.tech/images/db/es/es-th-2-5.jpeg)
...
![](https://www.pdai.tech/images/db/es/es-th-2-6.png)
...
![](https://www.pdai.tech/images/db/es/es-th-2-7.png)
...
![](https://www.pdai.tech/images/db/es/es-th-2-9.png)
...
![](https://www.pdai.tech/images/db/es/es-th-2-10.png)
...
![](https://www.pdai.tech/images/db/es/es-th-2-11.png)
