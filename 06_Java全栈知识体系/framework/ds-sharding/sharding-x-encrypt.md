...
> 根据业界对加密的需求及业务改造痛点，提供了一套完整、安全、透明化、低改造成本的数据加密整合解决方案，是 Apache ShardingSphere 数据加密模块的主要设计目标; 这篇文章主要转载自[ShardingSphere官方](https://shardingsphere.apache.org/document/5.1.0/cn/features/encrypt/)网站（V5.1.0版本），对开发者进阶设计通过数据库中间件进行数据脱敏、加密有着很大的借鉴意义。@pdai
...
![](https://www.pdai.tech/images/shardingsphere/sharding-x-encrpt-1.png)
...
![](https://www.pdai.tech/images/shardingsphere/sharding-x-encrpt-2.png)
...
![](https://www.pdai.tech/images/shardingsphere/sharding-x-encrpt-3.png)
...
![](https://www.pdai.tech/images/shardingsphere/sharding-x-encrpt-4.png)
...
![](https://www.pdai.tech/images/shardingsphere/sharding-x-encrpt-5.png)
...
![](https://www.pdai.tech/images/shardingsphere/sharding-x-encrpt-6.png)
...
![](https://www.pdai.tech/images/shardingsphere/sharding-x-encrpt-7.png)
...
![](https://www.pdai.tech/images/shardingsphere/sharding-x-encrpt-8.png)
