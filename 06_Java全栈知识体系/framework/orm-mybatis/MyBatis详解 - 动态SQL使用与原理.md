...
> 动态 SQL 是 MyBatis 的强大特性之一。如果你使用过 JDBC 或其它类似的框架，你应该能理解根据不同条件拼接 SQL 语句有多痛苦，例如拼接时要确保不能忘记添加必要的空格，还要注意去掉列表最后一个列名的逗号。利用动态 SQL，可以彻底摆脱这种痛苦。@pdai
...
![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-1.png)
...
![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-2.png)

BoundSql类，封装mybatis最终产生sql的类，包括sql语句，参数，参数源数据等参数：

![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-4.png)

XNode，一个Dom API中的Node接口的扩展类：

![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-5.png)

BaseBuilder接口及其实现类(属性，方法省略了，大家有兴趣的自己看),这些Builder的作用就是用于构造sql：

![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-6.png)
...
![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-7.png)
...
![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-8.png)

由于XMLConfigBuilder内部也是使用XMLMapperBuilder，我们就看看XMLMapperBuilder的解析细节：

![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-9.png)

![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-10.png)

我们关注一下，增删改查节点的解析：

![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-11.png)

XMLStatementBuilder的解析：

![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-12.png)

默认会使用XMLLanguageDriver创建SqlSource（Configuration构造函数中设置）。

XMLLanguageDriver创建SqlSource：

![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-13.png)

XMLScriptBuilder解析sql：

![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-14.png)
...
![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-15.png)

trim节点：

![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-16.png)

由于这个update方法是个动态节点，因此构造出了DynamicSqlSource。DynamicSqlSource内部就可以构造sql了:

![](https://www.pdai.tech/images/mybatis/mybatis-y-dynamic-sql-17.png)
