...
> 上文我们讲了Tomcat在初始化时会初始化classLoader。本文将具体分析Tomcat的类加载机制，特别是区别于传统的`双亲委派模型`的加载机制。@pdai
...
可以复习下类加载机制的基础：[JVM基础 - Java 类加载机制](../../java/jvm/java-jvm-classload.md)
...
![](https://www.pdai.tech/images/tomcat/tomcat-x-classloader-1.png)

结合经典的类加载机制，我们完整的看下Tomcat类加载图

![](https://www.pdai.tech/images/tomcat/tomcat-x-classloader-2.png)
