...
> 上文中介绍了Engine的设计，其中有Pipline相关内容没有介绍，本文将向你阐述Tomcat的管道机制以及它要解决的问题。@pdai
...
![](https://www.pdai.tech/images/tomcat/tomcat-x-pipline-3.jpg)

- 我们在上文Engine中有一块Pipline没有解释：

![](https://www.pdai.tech/images/tomcat/tomcat-x-pipline-1.jpg)
...
[责任链模式(Chain of responsibility pattern)](../../dev-spec/pattern/行为型 - 责任链(Chain Of Responsibility).md): 通过责任链模式, 你可以为某个请求创建一个对象链. 每个对象依序检查此请求并对其进行处理或者将它传给链中的下一个对象。
...
![](https://www.pdai.tech/images/tomcat/tomcat-x-pipline-7.jpg)
...
![](https://www.pdai.tech/images/tomcat/tomcat-x-pipline-2.jpg)
