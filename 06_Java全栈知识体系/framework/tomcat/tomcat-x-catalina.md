...
> 通过前两篇文章，我们知道了[Tomcat的类加载机制](tomcat-x-classloader.md)和[整体的组件加载流程](tomcat-x-start.md)；我们也知道通过Bootstrap初始化的catalinaClassLoader加载了Catalina，那么进而引入了一个问题就是Catalina是如何加载的呢？加载了什么呢？本文将带你进一步分析。@pdai
