...
首先是去官网下载Tomcat的源代码和二进制安装包，我这里分析最新的[Tomcat9.0.39稳定版本](https://tomcat.apache.org/download-90.cgi)https://tomcat.apache.org/download-90.cgi
...
![](https://www.pdai.tech/images/tomcat/tomcat-x-sourcecode-2.png)

- 查看二进制包中主要模块

![](https://www.pdai.tech/images/tomcat/tomcat-x-sourcecode-3.png)

### 编译源码

- 导入IDEA

![](https://www.pdai.tech/images/tomcat/tomcat-x-sourcecode-4.png)

- 使用ant编译

![](https://www.pdai.tech/images/tomcat/tomcat-x-sourcecode-1.png)
...
![](https://www.pdai.tech/images/tomcat/tomcat-x-sourcecode-5.png)

- 编译的输出结果是否对的上，很显然和上面的二进制包一致

![](https://www.pdai.tech/images/tomcat/tomcat-x-sourcecode-6.png)
