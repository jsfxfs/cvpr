...
![](https://www.pdai.tech/images/softskill/team-z-resources-mt-1.png)
...
![](https://www.pdai.tech/images/softskill/team-z-resources-mt-2.png)
...
![](https://www.pdai.tech/images/softskill/team-z-resources-mt-3.png)

### 1. 确定方法论

“凡事预则立，不预则废”。在做一件事之前，要充分评估整个工作完整生命周期的要素，并进行整体工作框架的设计，一个科学的方法论是十分有必要的。成本优化遵循的是一个**行业内成熟的P（Plan）D（Do）C（Check）A（Act）方法论**，在每个阶段都又有对应的二次迭代和微循环。具体方法论如下：
...
![](https://www.pdai.tech/images/softskill/team-z-resources-mt-4.png)

再根据开篇描述的方法，确定每个原子的评价指标，无法量化的项目都是“耍流氓”。这样就形成了一个更完整的金字塔结构，如下图所示：

![](https://www.pdai.tech/images/softskill/team-z-resources-mt-5.png)
...
![](https://www.pdai.tech/images/softskill/team-z-resources-mt-6.png)
...
![](https://www.pdai.tech/images/softskill/team-z-resources-mt-7.png)
...
1. **对于数据模型的热度**进行了分级，把数据分为冷、温、热数据，对于需要保留的数据才保存在生产环境的HDD、SSD中，对于不重要的冷数据，通过异构的方式存入其他介质中。
...
![](https://www.pdai.tech/images/softskill/team-z-resources-mt-8.png)
...
![](https://www.pdai.tech/images/softskill/team-z-resources-mt-9.png)
...
![](https://www.pdai.tech/images/softskill/team-z-resources-mt-10.png)
