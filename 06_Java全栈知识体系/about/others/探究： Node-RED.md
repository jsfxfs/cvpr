...
For more details, please check below official site: https://nodered.org/
...
![](https://www.pdai.tech/images/node-red/showcase-flow.png)
...
Check the issue and got this - http://blog.csdn.net/yypsober/article/details/51906616 So continue to config npm proxy:
...
/root/node-v8.9.1-linux-x64/bin/node-red -> /root/node-v8.9.1-linux-x64/lib/node_modules/images/node-red/red.js
/root/node-v8.9.1-linux-x64/bin/node-red-pi -> /root/node-v8.9.1-linux-x64/lib/node_modules/images/node-red/bin/node-red-pi
> bcrypt@1.0.3 install /root/node-v8.9.1-linux-x64/lib/node_modules/images/node-red/node_modules/bcrypt
> node-pre-gyp install --fallback-to-build
[bcrypt] Success: "/root/node-v8.9.1-linux-x64/lib/node_modules/images/node-red/node_modules/bcrypt/lib/binding/bcrypt_lib.node" is installed via remote
+ node-red@0.17.5
...
![](https://www.pdai.tech/images/node-red/node_red_overview.png)
...
![](https://www.pdai.tech/images/node-red/node_red_helloworld_0.png)

Add Input - Inject

![](https://www.pdai.tech/images/node-red/node_red_helloworld_1.png)

Add Output - Debug

![](https://www.pdai.tech/images/node-red/node_red_helloworld_2.png)

Deploy & Trigger to see result

![](https://www.pdai.tech/images/node-red/node_red_helloworld_3.png)

### Demo 2 - More flexible with functions

Create Flow

![](https://www.pdai.tech/images/node-red/node_red_second_0.png)

Add Input - Inject

![](https://www.pdai.tech/images/node-red/node_red_second_1.png)

Add Function

![](https://www.pdai.tech/images/node-red/node_red_second_2.png)

Add Delay 2s

![](https://www.pdai.tech/images/node-red/node_red_second_3.png)

Add Output - Debug

![](https://www.pdai.tech/images/node-red/node_red_second_4.png)

Deploy & Trigger to see result

![](https://www.pdai.tech/images/node-red/node_red_second_5.png)

### Demo 3 - Connect to MySQL

Create flow

![](https://www.pdai.tech/images/node-red/node_red_mysql_0.png)

Install mysql node

![](https://www.pdai.tech/images/node-red/node_red_mysql_1.png)

Setup mysql node - connection

![](https://www.pdai.tech/images/node-red/node_red_mysql_2.png)

Setup mysql node - label

![](https://www.pdai.tech/images/node-red/node_red_mysql_3.png)

Added function msg.topic - for mysql query test

![](https://www.pdai.tech/images/node-red/node_red_mysql_4.png)

Debug output

![](https://www.pdai.tech/images/node-red/node_red_mysql_5.png)

Json output

![](https://www.pdai.tech/images/node-red/node_red_mysql_6.png)

All other outputs

![](https://www.pdai.tech/images/node-red/node_red_mysql_7.png)

Added function msg.topic - for mysql update test

![](https://www.pdai.tech/images/node-red/node_red_mysql_8.png)

Run query result

![](https://www.pdai.tech/images/node-red/node_red_mysql_9.png)
...
![](https://www.pdai.tech/images/node-red/node_red_http_0.png)

Import By Clipboard

![](https://www.pdai.tech/images/node-red/node_red_http_1.png)
...
![](https://www.pdai.tech/images/node-red/node_red_http_2.png)

Then open url, you could got below page:

![](https://www.pdai.tech/images/node-red/node_red_http_3.png)
...
![](https://www.pdai.tech/images/node-red/node_red_http_4.png)

![](https://www.pdai.tech/images/node-red/node_red_http_5.png)
...
![](https://www.pdai.tech/images/node-red/node_red_mysql_restful_1.png)

Provide restful interfaces:

![](https://www.pdai.tech/images/node-red/node_red_mysql_restful_2.png)
...
![](https://www.pdai.tech/images/node-red/node_red_usage_siemens.png)
...
You may check below document: https://nodered.org/docs/api/
