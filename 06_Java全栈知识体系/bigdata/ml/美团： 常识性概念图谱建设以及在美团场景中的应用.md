# 美团: 常识性概念图谱建设以及在美团场景中的应用

> 常识性概念图谱，是围绕常识性概念建立的实体以及实体之间的关系，同时侧重美团的场景构建的一类知识图谱。本文介绍了美团常识性概念图谱构建的Schema，图谱建设中遇到的挑战以及建设过程中的算法实践，最后介绍了一些目前常识性概念图谱在业务上的应用，希望给大家带来一些帮助或启发。
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-2.jpeg)

## 二、常识性概念图谱介绍

常识性概念图谱就是建立概念与概念之间的关系，帮助自然语言文本的理解。同时我们的常识性概念图谱侧重美团场景，帮助提升美团场景中的搜索、推荐、Feeds流等的效果。
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-1.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-3.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-4.png)

**概念属性关系**：是典型的CPV（Concept-Property-Value）关系，从各个属性维度来描述和定义概念，例如火锅-口味-不辣，火锅-规格-单人等，示例如下：

![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-5.png)

概念属性关系包含两类。

- **预定义概念属性**：目前我们预定义典型的概念属性如下：

![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-6.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-7.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-8.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-9.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-10.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-11.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-11-1.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-12.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-13.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-14.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-15.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-16.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-17.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-18.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-19.png)

### 4.2 点评搜索引导

点评搜索SUG推荐，在引导用户认知的同时帮助减少用户完成搜索的时间，提升搜索效率。所以在SUG推荐上需要聚焦两个方面的目标：

- 帮助丰富用户的认知，从对点评的POI、类目搜索增加自然文本搜索的认知；
- 精细化用户搜索需求，当用户在搜索一些比较泛的品类词时，帮助细化用户的搜索需求。

在常识性概念图谱中，建立了很丰富的概念以及对应属性及其属性值的关系，通过一个相对比较泛的Query，可以生成对应细化的Query。例如蛋糕，可以通过口味这个属性，产出草莓蛋糕、芝士蛋糕，通过规格这个属性，产出6寸蛋糕、袖珍蛋糕等等。

搜索引导词Query产出示例如下图所示：

![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-20.png)
...
![](https://www.pdai.tech/images/bigdata/ml/ml-mt-tupu-cs-21.png)
...
- 作者：宗宇、俊杰、慧敏、福宝、徐俊、谢睿、武威等，均来自美团搜索与NLP部-NLP中心。
- 版权声明：本文为「美团技术团队」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
- 原文链接：https://tech.meituan.com/2021/06/24/nature-language-process-nlp-knowledge-graph.html