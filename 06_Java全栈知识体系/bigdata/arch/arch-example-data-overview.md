...
- [美团：外卖实时数仓建设实践](../../arch/arch-example-meituan-data-cangchu.md)
...
- [美团：数据治理一体化实践之体系化建模](../../arch/arch-example-meituan-data-zhili.md)
...
- [美团：业务数据治理体系化思考与实践](../../arch/arch-example-meituan-data-zhili2.md)
  - 美团住宿数据治理团队通过多年数仓建设及数据治理的经验沉淀，并结合业务发展阶段对于数据治理的诉求，将治理的思路逐步从专项、表象、问题驱动的治理，转变为自动化、体系化的治理，并从标准化、数字化、系统化三个方向进行了落地与实践。
- [美团：数据库异常智能分析与诊断](../../arch/arch-example-meituan-data-trouble.md)
