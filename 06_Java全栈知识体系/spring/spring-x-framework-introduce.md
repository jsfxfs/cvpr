...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-9.png)
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-10.png)
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-11.png)
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-12.png)
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-13.png)
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-0.png)

且官方对此专门对此做了详细介绍，感兴趣可以看下

![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-01.png)
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-4.png)

### Spring 的归档文档

官方提供了系统性的文档的FTP，你可以在[这里](https://docs.spring.io/spring-framework/docs/)找到所有历史版本的PDF/HTML版本。

![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-1.png)

可以看到很多系统性的文档，包括上面引用的图，

![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-3.png)

![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-2.png)

### Spring 的官方Github

Spring官方的GitHub在[这里](https://github.com/spring-projects/spring-framework)，它包含着Spring-framework的源码，如果你感兴趣，可以从这里clone代码进行阅读。

![](https://www.pdai.tech/images/spring/springframework/spring-framework-introduce-5.png)