...
> 在[Spring基础 - Spring简单例子引入Spring的核心](Spring基础 - Spring简单例子引入Spring要点.md)中向你展示了IoC的基础含义，同时以此发散了一些IoC相关知识点; 本节将在此基础上进一步解读IOC的含义以及IOC的使用方式。@pdai

## 引入

> 我们在[Spring基础 - Spring简单例子引入Spring的核心](Spring基础 - Spring简单例子引入Spring要点.md)中向你展示了IoC的基础含义，同时以此发散了一些IoC相关知识点。
...
- [Spring进阶- Spring IOC实现原理详解之Bean的注入和生命周期](Spring进阶- Spring IOC实现原理详解之Bean实例化(生命周期,循环依赖等).md)
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-ioc-1.png)
...
> 在[Spring基础 - Spring简单例子引入Spring的核心](Spring基础 - Spring简单例子引入Spring要点.md)已经给出了三种配置方式，这里再总结下；总体上目前的主流方式是 **注解 + Java 配置**。
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-ioc-3.png)

对于这个问题，说明你的类当中有太多的责任，那么你要好好想一想是不是自己违反了类的[单一性职责原则](../dev-spec/spec/软件开发中的原则 - SOLID.md#s%E5%8D%95%E4%B8%80%E8%81%8C%E8%B4%A3srp)，从而导致有这么多的依赖要注入。
