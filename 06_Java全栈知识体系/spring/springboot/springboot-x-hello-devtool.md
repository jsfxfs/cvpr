...
- **热加载**
  ...
  - 热加载的实现原理主要依赖[java的类加载机制](../../java/jvm/java-jvm-classload.md)，在实现方式可以概括为在容器启动的时候起一条后台线程，定时的检测类文件的时间戳变化，如果类的时间戳变掉了，则将类重新载入。
...
![](https://www.pdai.tech/images/spring/springboot/springboot-hello-devtool-1.png)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-hello-devtool-5.png)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-hello-devtool-7.png)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-hello-devtool-8.png)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-hello-devtool-3.png)

或者从浏览器插件中心下载，比如firefox:

![](https://www.pdai.tech/images/spring/springboot/springboot-hello-devtool-2.png)

安装完之后，可以通过如下图标管理

![](https://www.pdai.tech/images/spring/springboot/springboot-hello-devtool-4.png)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-hello-devtool-6.png)
