...
> 本文主要介绍分表分库，以及SpringBoot集成基于ShardingJDBC+MyBatis的单库分表实践。@pdai
...
![](https://www.pdai.tech/images/spring/springboot/spring-sharding-3.png)

### 和ShardingSphere是什么关系？
...
![](https://www.pdai.tech/images/spring/springboot/spring-sharding-1.png)

对应的版本功能

![](https://www.pdai.tech/images/spring/springboot/spring-sharding-2.png)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-sharding-1.png)

查询数据

![](https://www.pdai.tech/images/spring/springboot/springboot-sharding-2.png)
...
正是由于上述SNOWFLAKE雪花算法（相关文章请参考[分布式算法 - Snowflake算法](../../algorithm/alg-domain-id-snowflake.md)）， 相关ID是64位的long类型，所以需要设置相关字段位BIGINT类型。
