...
[百度百科](https://baike.baidu.com/item/%E8%87%B4%E5%8A%A8%E5%99%A8/56538368?fr=aladdin)的解释如下： 致动器能将某种形式的能量转换为机械能的驱动装置。如热致动器、磁致动器等，在磁盘中是指将电能转换为机械能并带动磁头运动的装置。
...
![](https://www.pdai.tech/images/spring/springboot/springboot-actuator-1.png)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-actuator-5.png)

访问效果

![](https://www.pdai.tech/images/spring/springboot/springboot-actuator-2.png)

#### 组件的health状况

SpringBoot默认集成了如下常见中间件的health监控

![](https://www.pdai.tech/images/spring/springboot/springboot-actuator-3.png)
...
更详细的信息可以参考[官网](https://docs.spring.io/spring-boot/docs/current/reference/html/actuator.html#actuator.endpoints.health)

#### Metrics接入监控系统

这个也是比较常用的，具体参考

![](https://www.pdai.tech/images/spring/springboot/springboot-actuator-4.png)
