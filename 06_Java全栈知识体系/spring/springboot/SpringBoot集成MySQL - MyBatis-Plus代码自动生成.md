...
> 本文主要介绍 MyBatis-Plus代码自动生成，以及产生此类代码生成工具的背景和此类工具的基本实现原理。@pdai
...
![](https://www.pdai.tech/images/spring/springboot/springboot-engine-1.png)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-mybatisplus-gen-1.png)
