...
![](https://www.pdai.tech/images/spring/springboot/springboot-exception-1.png)
...
我们在[Spring基础 - SpringMVC案例和机制](../Spring基础 - SpringMVC请求流程和案例.md)的基础上来看@ControllerAdvice的源码实现。
...
如下方法是获取所有的HandlerAdapter，无非就是从BeanFactory中获取（BeanFactory相关知识请参考 [Spring进阶- Spring IOC实现原理详解之IOC体系结构设计](../Spring进阶- Spring IOC实现原理详解之IOC体系结构设计.md))
...
![](https://www.pdai.tech/images/spring/springboot/springboot-exception-10.png)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-exception-11.png)
