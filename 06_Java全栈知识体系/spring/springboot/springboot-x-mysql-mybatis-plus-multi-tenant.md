...
> 本文主要介绍 MyBatis-Plus的基于字段隔离的多租户实现，以及MyBatis-Plus的基于字段的隔离方式实践和原理。@pdai
...
### MyBatis-Plus的基于字段的隔离方式原理是什么？

这里请看MyBatis的插件机制：[MyBatis详解 - 插件机制](../../framework/orm-mybatis/mybatis-y-plugin.md)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-mybatis-plus-tenant-1.png)
