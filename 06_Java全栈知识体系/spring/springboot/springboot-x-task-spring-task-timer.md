...
> cron表达式， 以及BeanPostProcessor（方便你理解它的原理，相关介绍在之前的文章中[Spring核心之控制反转(IOC)源码解析](../spring-x-framework-ioc-source-3.md)）.
...
什么是BeanPostProcessor? 我们在前文中有详解的讲解，具体看[Spring核心之控制反转(IOC)源码解析](../spring-x-framework-ioc-source-3.md)
