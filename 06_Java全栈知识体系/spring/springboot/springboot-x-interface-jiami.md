...
- **接口传输**
  - http明文传输数据？
- **其它方面**
  - 接口重放，上文介绍的[接口幂等](springboot-x-interface-mideng.md)
  - 接口超时，加timestamp控制？
  - ...
...
![](https://www.pdai.tech/images/spring/springboot/springboot-api-sign-1.png)
...
> 从接口传输安全的角度，防止接口数据明文传输， 具体可以看[这里](../../develop/protocol/dev-protocol-http.md#%E8%AE%A4%E8%AF%81)
...
![](https://www.pdai.tech/images/spring/springboot/springboot-sign-2.png)

如果不带X-SIGN

![](https://www.pdai.tech/images/spring/springboot/springboot-sign-3.png)

如果X-SIGN错误

![](https://www.pdai.tech/images/spring/springboot/springboot-sign-4.png)

如果X-SIGN正确

![](https://www.pdai.tech/images/spring/springboot/springboot-sign-1.png)
