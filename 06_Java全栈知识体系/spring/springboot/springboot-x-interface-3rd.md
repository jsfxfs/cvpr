...
> 在SpringBoot接口开发中，存在着本模块的代码需要访问外面模块接口或外部url链接的需求, 比如调用外部的地图API或者天气API。那么有哪些方式可以调用外部接口呢？@pdai
...
具体原因可以参考[使用Spring Schedule要注意什么](springboot-x-task-spring-task-timer.md#%E4%BD%BF%E7%94%A8spring-schedule%E8%A6%81%E6%B3%A8%E6%84%8F%E4%BB%80%E4%B9%88)
