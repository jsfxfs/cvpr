...
> 这里以一个Helloworld项目（[SpringBoot入门 - 创建第一个Hello world工程](SpringBoot入门 - SpringBoot HelloWorld.md)）为例打包成war。
...
请参看：[SpringBoot应用部署 - 打包成jar部署](-SpringBoot应用部署 - 打包成jar部署.md)
