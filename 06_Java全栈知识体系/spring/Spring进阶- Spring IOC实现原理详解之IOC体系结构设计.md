...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-ioc-source-7.png)
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-ioc-source-2.png)
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-ioc-source-3.png)

- **BeanDefinitionReader**

Bean 的解析过程非常复杂，功能被分的很细，因为这里需要被扩展的地方很多，必须保证有足够的灵活性，以应对可能的变化。Bean 的解析主要就是对 Spring 配置文件的解析。这个解析过程主要通过下图中的类完成：

![](https://www.pdai.tech/images/spring/springframework/spring-framework-ioc-source-5.png)

- **BeanDefinitionHolder**

BeanDefinitionHolder 这是BeanDefination的包装类，用来存储BeanDefinition，name以及aliases等

![](https://www.pdai.tech/images/spring/springframework/spring-framework-ioc-source-4.png)
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-ioc-source-51.png)
...
![](https://www.pdai.tech/images/spring/springframework/spring-framework-ioc-source-61.png)
