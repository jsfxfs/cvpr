...
> 通常我们使用quartz只是实现job单实例运行，本例将展示quartz实现基于数据库的分布式任务管理，和控制job生命周期。@pdai

## 效果如下

展示正在运行的Jobs:

![](https://www.pdai.tech/images/spring/springboot-data-quartz-1.png)

增加新的Job:

![](https://www.pdai.tech/images/spring/springboot-data-quartz-2.png)

Jobs持久化在数据库:

![](https://www.pdai.tech/images/spring/springboot-data-quartz-3.png)
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<description>quartz_demo</description>
...
```java
package com.pdai.job.quarz.entity;

import java.util.Date;

/** 
 * <b>ClassName</b>: JobAndTrigger <br/> 
 *
 * <b>Description</b>: JobAndTrigger <br/> 
 *
 * <b>Date</b>: Jan 28, 2019 11:13:29 AM <br/> 
 * 
 * @author pdai
 * @version Jan 28, 2019
 *
...
public class JobDetails{
	...
	private String triggerGroupName, triggerName;
	private String jobGroupName, jobName;
	private Date nextFireTime, previousFireTime;
...
```java
package com.pdai.job.quarz.manager;
...
import com.pdai.job.quarz.entity.JobDetails;

/** 
 * <b>ClassName</b>: QuartzManager <br/> 
 *
 * <b>Description</b>: QuartzManager <br/> 
 *
 * <b>Date</b>: Jan 28, 2019 1:21:27 PM <br/> 
 * 
 * @author pdai
 * @version Jan 28, 2019
 *
...
public class QuartzManager {
	...
	public PageInfo<JobDetails> queryAllJobBean(int pageNum, int pageSize) {
		...
		return new PageInfo<JobDetails>(jobList);
	}
...
```java
package com.pdai.job.quarz.controller;
...
import com.github.pagehelper.PageInfo;
import com.pdai.job.quarz.entity.JobDetails;
import com.pdai.job.quarz.manager.QuartzManager;

/**
 * <b>ClassName</b>: JobController <br/>
 *
 * <b>Description</b>: JobController <br/>
 *
 * <b>Date</b>: Jan 28, 2019 11:10:41 AM <br/>
 * 
 * @author pdai
 * @version Jan 28, 2019
 *
...
```java
package com.pdai.job.quarz.job;
...
/**
 * <b>ClassName</b>: HelloJob <br/>
 *
 * <b>Description</b>: HelloJob <br/>
 *
 * <b>Date</b>: Jan 28, 2019 11:13:46 AM <br/>
 * 
 * @author pdai
 * @version Jan 28, 2019
 *
...
@See https://github.com/realpdai/springboot-job-quartz-demo