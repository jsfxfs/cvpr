...
> 本例展示一个Mongo CURD 的Demo, 由于我在[springboot多数据源](Spring Boot - 多个数据源Service层封装.md)示例中已经使用了JPA形式的MongoRepository，所以在这个例子中我将只展示使用MongoTemplate(MongoOptions)方式。 @pdai
