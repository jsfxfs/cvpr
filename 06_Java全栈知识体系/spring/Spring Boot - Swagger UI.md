...
> 本例也是一个Spring Boot的Hello World 应用。@pdai 包含, 对用户基本数据增删查改:
>
> - SpringBoot
> - JPA
> - H2
...
![](https://www.pdai.tech/images/spring/springboot-swagger-2.png)

模型展示

![](https://www.pdai.tech/images/spring/springboot-swagger-3.png)
