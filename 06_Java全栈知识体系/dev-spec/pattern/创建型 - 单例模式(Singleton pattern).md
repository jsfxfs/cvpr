...
> 本文主要分析单例模式(Singleton pattern): 确保一个类只有一个实例，并提供该实例的全局访问点, 本文介绍6中常用的实现方式。@pdai
...
![](https://www.pdai.tech/images/pics/562f2844-d77c-40e0-887a-28a7128abd42.png)

## 6中实现方式

### 实现方式总结

![](https://www.pdai.tech/images/design_part/2_singleton_1.png)
