...
- [SpringBoot定时任务 - Netty HashedWheelTimer方式](spring/springboot/SpringBoot定时任务 - Netty HashedWheelTimer方式.md)
- [SpringBoot定时任务 - 分布式elastic-job方式](spring/springboot/SpringBoot定时任务 - 分布式elastic-job方式.md)
- [SpringBoot定时任务 - 分布式xxl-job方式](spring/springboot/SpringBoot定时任务 - 分布式xxl-job方式.md)
- [SpringBoot后端视图 - 基于Thymeleaf视图解析](spring/springboot/-SpringBoot后端视图 - 基于Thymeleaf视图解析.md)
...
- 【秒杀抽奖】系统
  - [【秒杀抽奖】秒杀系统设计](arch/【秒杀抽奖】秒杀系统设计.md)
...
- 【电商交易】系统
  - [【电商交易】京东-亿级商品详情页设计](arch/【电商交易】京东-亿级商品详情页设计.md)
  - [【电商交易】闲鱼-亿级商品结构化背后的思考和演进](arch/【电商交易】闲鱼-亿级商品结构化背后的思考和演进.md)
  - [【电商交易】闲鱼-多状态多操作的交易链路架构演进](arch/【电商交易】闲鱼-多状态多操作的交易链路架构演进.md)
...
- 【仓储物流】系统
  ...
  - [【仓储物流】美团-配送系统架构演进实践](arch/【仓储物流】美团-配送系统架构演进实践.md)
  - [【仓储物流】美团-即时物流的分布式系统架构设计](arch/【仓储物流】美团-即时物流的分布式系统架构设计.md)
- 【拉新投放】系统
  - [【拉新投放】闲鱼-拉新投放系统如何设计](arch/【拉新投放】闲鱼-拉新投放系统如何设计.md)
- 【综合/其它】
  - [【综合/其它】闲鱼-复杂搜索系统的可靠性优化之路](arch/【综合-其它】闲鱼-复杂搜索系统的可靠性优化之路.md)
  - [【综合/其它】美团-外卖客户端高可用建设体系](arch/【综合-其它】美团-外卖客户端高可用建设体系.md)

### 架构设计之数据仓库平台

- 数据仓库
  - [美团: 数据库高可用架构的演进与设想](arch/美团： 数据库高可用架构的演进与设想.md)
  - [美团: 数据同步到仓库的架构实践](arch/美团： 数据同步到仓库的架构实践.md)
